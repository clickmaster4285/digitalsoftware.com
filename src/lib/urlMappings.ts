...
const specialCases: Record<string, LocationMapping> = {
  ...
  'seo-services-louisville': {
    ...
    city: 'Louisville',
    country: 'US',
    validPaths: ['/search-engine-optimization/locations/seo-services-louisville/']
  },
  'seo-services-knoxville': {
    service: 'SEO',
    city: 'Knoxville',
    country: 'US',
    validPaths: ['/search-engine-optimization/locations/seo-services-knoxville/']
  },
  'seo-services-memphis': {
    service: 'SEO',
    city: 'Memphis',
    country: 'US',
    validPaths: ['/search-engine-optimization/locations/seo-services-memphis/']
  },
  'seo-services-oklahoma-city': {
    service: 'SEO',
    city: 'Oklahoma City',
    country: 'US',
    validPaths: ['/search-engine-optimization/locations/seo-services-oklahoma-city/']
  }
};
