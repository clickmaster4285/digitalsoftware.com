export const ShopifyMarketingContent = {
  ...
  hero: {
    ...
    stats: [
      ...
      { k: "9.25x", v: "organic sessions growth in 14 months" },
      { k: "10+ yrs", v: "Shopify marketing expertise" },
    ],
  },
  intro: {
    problem: [
      {
        text: "Most Shopify store owners have built the store. They understand the product and the customer. What they have not built — because it requires marketing expertise that most product founders do not have — is the ",
        type: "normal",
      },
      {
        text: "systematic, channel-diversified marketing operation",
        type: "highlight",
      },
      {
        text: " that fills the store with buyers who keep coming back.",
        type: "normal",
      },
    ],
    solution:
  ...
  services: [
    ...
    },
    {
      ...
      title: "Shopify Paid Advertising",
      intro:
    ...
    },
    {
      ...
      icon: "Mail",
      tag: "Email & SMS",
      title: "Shopify Email and SMS Marketing",
      intro:
    ...
    },
    {
      ...
      tag: "CRO",
      title: "Shopify Conversion Rate Optimisation",
      intro:
  ...
  faqs: [
    ...
    },
    {
      ...
      a: "Book a free Shopify marketing audit. We review your Shopify analytics, your current marketing channels and their performance, your Klaviyo or email setup, and your conversion rate data — and identify the specific growth opportunities and the marketing programme most likely to capture them. We provide a specific revenue growth projection and a recommended marketing programme to achieve it. No commitment required at the audit stage.",
    },
  ],
  cta: {
