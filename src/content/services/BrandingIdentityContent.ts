export const BrandingIdentityContent = {
  slug: "branding-identity-services",
  metadata: {
    url: "/branding-identity-services/",
  ...
  hero: {
    tag: "[ Service · 18 ] BRANDING",
    title: "Branding & Identity Services — The Strategic Foundation",
    ...
    stats: [
      ...
      { k: "3x", v: "enterprise shortlistings increase" },
      { k: "27,100/mo", v: "primary keyword volume" },
    ],
  },
  intro: {
    problem: [
      { text: "The difference between businesses that are known and trusted in their markets and those that are invisible or interchangeable is almost always the strategic clarity and consistency of the brand. The known and trusted business has made deliberate decisions about who it is for, what it stands for, and how it is different from the alternatives — and has built the visual and verbal system that communicates those decisions consistently. The invisible or interchangeable business has focused on products and services without investing in the ", type: "normal" },
      { text: "strategic foundation", type: "highlight" },
      { text: " that makes those products and services recognisable and preferable.", type: "normal" }
    ],
    solution:
    ...
    promise: "We serve clients across the USA, UK, UAE, and Pakistan — across every sector from professional services and technology to consumer goods, hospitality, and manufacturing.",
  },
  services: [
    {
      n: "01",
  ...
  faqs: [
    ...
    {
      q: "Can you rebrand us without losing the equity in our existing brand?",
      a: "Brand equity preservation is a primary consideration in every rebranding engagement. We begin rebranding engagements with a brand audit that specifically assesses what equity exists in the current brand — what recognition, what positive associations, what loyalty — and what would be lost in a full rebrand versus a refresh. Where significant equity exists, we design brand evolution strategies that preserve the equity-bearing elements while updating the elements that are limiting the brand. Where the existing brand has minimal equity and significant negative associations, a clean break is usually more valuable than incremental evolution.",
    },
    {
      q: "What happens to our brand guidelines after the engagement ends?",
      a: "Brand guidelines are delivered as your permanent, owned reference documentation — you are not dependent on our ongoing involvement to apply them. We deliver guidelines in formats designed for operational use: PDF master documents for external parties, web-based portals for internal teams, and executable Figma and template asset libraries. We also offer ongoing brand governance retainers for businesses that want periodic brand audits, new touchpoint application guidance, and on-call brand counsel as the business evolves. The retainer is optional — the guidelines are designed to be self-sufficient without it.",
    },
    {
      q: "How do you handle brand strategy for businesses with multiple audiences?",
      a: "Many businesses serve multiple audience segments with different needs, preferences, and decision-making criteria — and the brand strategy must serve all of them without contradicting itself. We address this through audience segmentation within a unified brand positioning: the core brand positioning is designed to be compelling and credible across all primary audience segments, while the messaging framework and communication approach varies by segment. The brand communicates consistently (the same values, personality, and visual identity) while communicating differently (different emphasis, different proof points, different tone calibration) for each audience.",
    },
    {
      q: "How do I get started?",
      a: "Book a free brand consultation. We discuss your business's current brand situation, your strategic objectives for the brand engagement, your competitive context, and your target audiences. We provide an initial assessment of the brand strategy and identity work required and a scoped proposal. No commitment required at the consultation stage.",
    },
  ],
  cta: {
