export const GoogleAdsManagementContent = {
  ...
  hero: {
    ...
    stats: [
      ...
      { k: "1.6x → 5.2x", v: "ROAS improvement (client example)" },
      { k: "8.5B", v: "daily searches on Google" },
    ],
  },
  intro: {
    problem: [
      { text: "The difference between Google Ads that waste your budget and Google Ads that generate profitable, scalable revenue is ", type: "normal" },
      { text: "not the platform — it is the management", type: "highlight" },
      { text: ". The precision with which your account is structured. The discipline with which wasted spend is identified and eliminated. The sophistication with which Smart Bidding is calibrated and conversion data is fed to the algorithm. The creative quality that earns clicks from buyers rather than browsers.", type: "normal" }
    ],
    solution:
  ...
  services: [
    ...
    },
    {
      ...
      icon: "LineChart",
      tag: "Smart Bidding",
      title: "Smart Bidding and Conversion Data Management",
      intro: "Google's AI-powered bidding algorithms are powerful — but they optimize toward whatever conversion data they are given.",
      blocks: [
        {
          h: "Conversion Tracking Implementation",
          p: "We implement and audit conversion tracking for every conversion type that matters to your business: form submissions (with specific form differentiation by form type and lead quality), phone calls (with call duration thresholds to filter low-quality calls), e-commerce purchases (with transaction values for ROAS optimization), appointment bookings, and any other conversion actions representing genuine business value. We verify conversion tracking against actual business data and implement Enhanced Conversions (sending hashed first-party customer data to Google to improve conversion matching and attribution accuracy) for all eligible accounts.",
        },
        {
          h: "Smart Bidding Strategy Calibration",
          p: "The choice between Target CPA, Target ROAS, Maximize Conversions, and Maximize Conversion Value — and the specific targets set for each — directly determines how the algorithm allocates budget across impressions. We calibrate targets based on business profitability requirements, adjust them incrementally as account data accumulates, and monitor Smart Bidding learning phase indicators to avoid disruptive changes during active learning periods.",
        },
      ],
    },
  ],
  process: {
    title: "Our Google Ads Management Process — From Audit to",
    titleHighlight: "Profitable Scale",
    steps: [
      {
        days: "Week 1–2",
        title: "Account audit or new account architecture",
        description: "Existing accounts: comprehensive audit covering account structure, keyword analysis, search term data, conversion tracking verification, Quality Score assessment, and performance benchmark documentation. New accounts: keyword research, campaign architecture design, conversion tracking implementation, and creative brief development.",
      },
      {
        days: "Week 3–4",
        title: "Implementation",
        description: "Account restructuring or new campaign build. Conversion tracking verification and Enhanced Conversions implementation. Ad creative development and upload. Bid strategy configuration. Negative keyword list seeding. Landing page assessment and recommendations.",
      },
      {
        days: "Month 2",
        title: "Monitoring and initial optimization",
        description: "Daily monitoring for budget pacing, CPC anomalies, and conversion tracking issues. Weekly search term analysis and negative keyword additions. Quality Score monitoring. Smart Bidding learning phase management.",
      },
      {
        days: "Month 3–4",
        title: "Data-driven optimization",
        description: "First meaningful optimization sprint: pausing underperforming keywords and ad groups, expanding high-performing keyword variations, creative testing analysis and new asset development, audience segment performance review, bid strategy target adjustment based on observed conversion patterns.",
      },
      {
        days: "Month 5+",
        title: "Scaling profitable elements",
        description: "Budget reallocation toward highest-ROAS campaigns and keywords. Geographic expansion where performance data supports it. New campaign type testing. Monthly executive reporting connecting ad spend to revenue outcomes.",
      },
    ],
  },
  cases: [
    {
      tag: "B2B Legal Services · Search",
      metric: "58%",
      sub: "cost-per-lead reduction · $580 → $241",
      title: "B2B legal services firm reduces cost-per-lead by 58% in 90 days.",
      body: "A personal injury law firm in New York was spending $35,000 per month on Google Search campaigns with a cost-per-lead of $580. The account had all practice areas in a single campaign, broad match keywords including clearly non-commercial queries, and Smart Bidding optimizing toward an all-conversion metric that included low-quality blog page views. Our restructure: eight separate campaigns by practice area, phrase and exact match for highest-cost terms, conversion tracking remediation excluding blog page views from Smart Bidding optimization signals, and new RSA creative testing value proposition vs social proof vs outcome-focused headlines across each practice area.",
      result: "Cost-per-qualified-lead dropped from $580 to $241 within 90 days — a 58% reduction. Monthly qualified lead volume increased from 60 to 145 on the same $35,000 budget. The restructure that produced this result took three weeks to implement.",
    },
    {
      tag: "E-commerce · Shopping",
      metric: "1.6x → 5.2x",
      sub: "ROAS improvement · 5 months",
      title: "E-commerce outdoor equipment brand improves Shopping ROAS from 1.6x to 5.2x in 5 months.",
      body: "An outdoor equipment e-commerce brand was running an unstructured Google Shopping campaign with a 1.6x ROAS. The product feed had missing GTINs on 40% of products, generic product titles, no campaign segmentation by product margin, and no audience layering. Our program: complete product feed audit and remediation (GTIN mapping for 340 products, product title rewrites for the 200 highest-revenue products, category taxonomy correction for 85 miscategorized products), campaign segmentation by product tier and margin profile, remarketing audience layering with bid adjustments, Performance Max campaign testing for the 30 bestselling SKUs.",
      result: "ROAS improved from 1.6x to 5.2x over 5 months. Monthly Shopping revenue increased from $120,000 to $390,000. The feed optimization alone — requiring no additional ad spend — accounted for approximately 60% of the ROAS improvement by dramatically increasing impression share on high-value, previously underserved product categories.",
    },
    {
      tag: "Healthcare · Multi-Location",
      metric: "280%",
      sub: "appointment bookings increase · $195 → $74 CPA",
      title: "Healthcare provider drives 280% increase in appointment bookings through location-level segmentation.",
      body: "A multi-specialty healthcare practice in Houston was running Google Search campaigns for five clinic locations — but all campaigns shared a single budget, a single ad creative, and no geographic bid adjustments differentiating performance between locations. Cost-per-appointment-booking was $195. Our restructure: location-level campaign segmentation (five dedicated campaigns, one per clinic location), location bid adjustments reflecting each location's conversion rate from historical data, appointment booking as the primary conversion action, call tracking integration connecting inbound phone calls to specific keywords and locations, and clinical service segmentation within each location campaign.",
      result: "Cost-per-appointment-booking dropped to $74 within 4 months. Monthly appointment bookings attributed to Google Ads increased from 320 to 896 — a 280% increase — on a budget that increased by only 35%.",
    },
  ],
  why: [
    {
      icon: "BadgeCheck",
      h: "Google Certified Specialists — current, active certifications",
      p: "Our Google Ads team holds current certifications in Google Search Advertising, Google Shopping Advertising, Google Display Advertising, Google Video (YouTube) Advertising, and Performance Max. We complete continuing education requirements each certification cycle — ensuring our methodology reflects current platform best practices.",
    },
    {
      icon: "DollarSign",
      h: "$28M+ in managed Google Ads spend",
      p: "Managing significant spend at scale develops pattern recognition that no certification program replicates. We have seen what drives performance across hundreds of account types, industries, budget levels, and markets — and we apply those cross-account learnings to each individual client's optimization strategy.",
    },
    {
      icon: "ClipboardCheck",
      h: "Complete conversion tracking before campaign optimization",
      p: "We do not optimize campaigns with broken or incomplete conversion tracking. Before any optimization work begins, we verify that every meaningful conversion action is being tracked accurately and that Smart Bidding is receiving the right optimization signal. This commitment adds time at the engagement start and prevents months of well-intentioned optimization toward the wrong objective.",
    },
    {
      icon: "Database",
      h: "Your account, your data, your history",
      p: "We manage within your Google Ads account — not our own MCC-owned account structures. Everything we build, every audience we create, every conversion history we accumulate, every negative keyword list we develop remains in your account and belongs to you permanently.",
    },
  ],
  faqs: [
    {
      q: "What is the minimum budget required to run effective Google Ads?",
      a: "The minimum effective budget depends on your industry's average cost-per-click and your target conversion volume. Google's Smart Bidding requires a minimum of approximately 30 conversions per month per campaign to function effectively — meaning your budget needs to be sufficient to generate that conversion volume. In a competitive service category with $25 CPCs and a 5% conversion rate, you need at least $15,000 per month in Search spend. In a lower-competition niche with $3 CPCs and a 10% conversion rate, $1,000 per month may be sufficient. We provide a specific minimum budget recommendation based on your industry and target keywords before you commit.",
    },
    {
      q: "How does Google decide which ads to show and in what order?",
      a: "Google uses Ad Rank — a real-time calculation combining your bid, your Quality Score (1–10, evaluating keyword-ad-landing page relevance), and the expected impact of your ad extensions — to determine both whether your ad appears and in what position. An advertiser with a $10 bid and a Quality Score of 8 can outrank an advertiser with a $15 bid and a Quality Score of 4 — and pay less per click for a better position. This is why Quality Score improvement is one of our highest-priority optimization activities.",
    },
    {
      q: "What is Performance Max and should I be using it?",
      a: "Performance Max is Google's fully automated campaign type that serves ads across all of Google's channels from a single campaign. In 2026, it is mandatory for Google Shopping advertisers and increasingly recommended for Search advertisers with sufficient conversion data and creative assets. PMax works best for: businesses with strong conversion tracking and clear revenue signals, accounts with existing customer lists and remarketing audiences, and campaigns with a diverse creative asset library. We assess PMax appropriateness as part of every account audit and implement it where it is likely to improve performance.",
    },
    {
      q: "How do you prevent my ads from showing for irrelevant searches?",
      a: "Through ongoing negative keyword management — the practice of identifying irrelevant queries that triggered your ads and adding those queries as negative keywords. We conduct weekly search term analysis for all active campaigns, reviewing every query that generated a click and adding irrelevant terms to negative keyword lists at the campaign or account level. We also proactively add negative keyword categories based on known patterns for your industry — competitor brand names, information-only queries, geographic terms outside your service area, and job-seeker queries.",
    },
    {
      q: "Can you take over my existing Google Ads account without disrupting performance?",
      a: "Yes — we transition accounts carefully to preserve performance continuity. Our standard transition process: read-only access review for the first week (building thorough understanding of the existing structure before making changes), documentation of current performance baseline (we know exactly what good looks like before we touch anything), and incremental optimization rather than wholesale restructuring. Wholesale account rebuilds are only implemented when the existing structure is so deeply problematic that incremental improvement would take longer than rebuilding correctly from scratch.",
    },
    {
      q: "How do you report on Google Ads performance?",
      a: "Monthly reports include: ad spend by campaign, impressions, clicks, CTR, average CPC, Quality Score trend, conversion volume by conversion type, cost-per-conversion, total conversion value, ROAS, and comparison to prior month and prior year. We write campaign-by-campaign performance commentary explaining what changed, why it changed, what we did about it, and what we plan next month.",
    },
    {
      q: "What happens to my Google Ads account if I stop working with Clickmasters?",
      a: "Everything stays with you. The account is yours — the campaign structure we built, the negative keyword lists we developed, the audience lists we created, the conversion history we accumulated, the creative assets we uploaded. We provide a transition brief documenting the account's current configuration, active tests, and recommended next steps.",
    },
    {
      q: "We tried Google Ads before and it did not work. Why would it work now?",
      a: "Google Ads 'not working' almost always traces to a specific, identifiable cause — commonly: incorrect keyword targeting (bidding on broad queries with no purchase intent), misconfigured conversion tracking (optimizing toward the wrong metric), insufficient budget (not enough clicks to generate statistically meaningful conversion data), poor landing page alignment (sending paid traffic to a homepage rather than an intent-matched landing page), or inadequate management attention. Our account audit process identifies the specific reason previous campaigns underperformed and addresses it directly before spending a dollar.",
    },
    {
      q: "How do I get started?",
      a: "Book a free Google Ads audit. We review your current account (or outline a new account architecture if you are starting fresh), identify the top five specific issues or opportunities, and give you a clear picture of the performance improvement our management could deliver. No commitment required at the audit stage.",
    },
  ],
  cta: {
