export const PrMediaOutreachContent = {
  slug: "pr-media-outreach-services",
  metadata: {
    url: "/pr-media-outreach-services/",
    keyword: "digital pr services",
    volume: "8,100/mo",
    cpc: "$38.60",
    formula: "PASTOR",
    author: "Amjad Khan",
  ...
  hero: {
    ...
    stats: [
      ...
      { k: "AED 142M", v: "Qualified pipeline" },
    ],
  },
  intro: {
    problem: [
  ...
  problem: {
    ...
    titleHighlight: "No Earned Media Presence",
    items: [
      {
        icon: "Mail",
    ...
    afterItems: [
      ...
      },
      {
        icon: "PenTool",
        title: "Pitch Writing",
        body: "Press releases and pitches that lead with the story angle, include specific data and expert quotes, are personalised to each journalist's beat, and are structured to make the journalist's job as easy as possible.",
      },
    ],
  },
  services: [
      ...
      blocks: [
        {
          ...
          p: "We develop PR stories from proprietary data and survey findings (original research is the most consistently successful story angle), thought leadership perspectives (expert commentary on industry trends), case study narratives (specific client outcomes), and newsjacking (rapid-response commentary on breaking news).",
        },
      ],
    },
    {
      ...
      blocks: [
        {
          ...
          p: "We build targeted media lists: the specific journalists and editors at each target publication who cover the relevant beat, analysis of their recent coverage to ensure relevance, and monitoring of editorial calendars for advance pitch timing.",
        },
        {
          h: "Multi-Market Targeting",
          p: "UK PR: The Times, The Guardian, The Telegraph, Financial Times, Management Today, City A.M. US PR: national business and trade publications. UAE PR: Gulf News, Khaleej Times, Arabian Business.",
        },
      ],
    },
    {
      ...
      blocks: [
        {
          ...
          p: "We write pitches that lead with the story angle (why readers would find this interesting), include specific data and expert quotes, are personalised to each journalist's beat and recent coverage, and are structured to make the journalist's job as easy as possible.",
        },
      ],
    },
    {
      ...
      blocks: [
        {
          ...
          p: "We develop thought leadership programmes: contributed article pipelines, expert commentary databases (positioning spokespeople as available informed sources), podcast outreach, and media spokesperson briefing for repeat journalist engagement.",
        },
      ],
    },
    {
      ...
      intro:
        "Managing negative media coverage and responding to reputational threats is as commercially significant as proactive PR.",
      blocks: [
        {
          h: "Protecting the Brand When the Story Is Not the One You Wanted",
          p: "We provide crisis communications support: issue monitoring (tracking potential stories before they develop), response strategy (message, spokespeople, timing), journalist engagement (providing perspective before publication), and recovery PR (rebuilding narrative after a reputational event).",
        },
      ],
    },
  ],
  cases: [
    ...
    },
    {
      ...
      metric: "14",
      sub: "trade press placements · category authority",
      title: "US B2B technology company PR programme generates 14 trade press placements and builds category authority.",
      body: "A US B2B construction management software company needed category authority. Our programme: construction technology thought leadership series (contributed articles in Construction Dive, ConstructionWeek, ENR), newsjacking on industry regulatory news, and a survey-based story (construction productivity survey). Result: 14 trade press placements in 12 months, organic rankings improved, sales team reported inbound prospects increasingly referenced having read about the company in industry publications.",
    },
    {
      tag: "Dubai Real Estate · Luxury",
      metric: "AED 142M",
      sub: "qualified pipeline · 28 → 96 enquiries/month",
      title: "Dubai luxury real estate developer UAE and UK PR programme generates AED 142M in qualified international enquiries.",
      body: "A Dubai luxury off-plan property developer needed international buyer recognition. Our programme: UK media outreach to property journalists at The Sunday Times, The Times, FT, The Negotiator, Property Week; UAE media outreach to Gulf News, Khaleej Times, Arabian Business; CEO thought leadership. Result: 18 editorial placements across UK and UAE press, international enquiry volume grew 240%, qualified enquiries grew from 28 to 96/month, sales director attributed AED 142M in qualified pipeline to PR.",
    },
  ],
  why: [
    {
    ...
    {
      icon: "TrendingUp",
      h: "SEO and PR alignment",
      p: "Our digital PR programmes are designed with organic search impact as an explicit objective alongside brand coverage. Publications are selected for domain authority, not just audience quality. Anchor text and linking context is considered in every pitch. PR and SEO are coordinated to maximise organic ranking impact.",
    },
    {
      icon: "Globe",
  ...
  faqs: [
    ...
    },
    {
      ...
      a: "We measure results against: editorial placements (number, publication authority, reach), backlink quality (domain authority of linking publications, link type), organic search impact (ranking improvements attributable to authority signals), brand search volume growth (indicator of increased brand awareness), and where trackable, direct commercial outcomes of specific placements (enquiries, sales, investor approaches).",
    },
    {
