export const NewsletterContent = {
  ...
  hero: {
    ...
    stats: [
      ...
      { k: "2,900/mo", v: "Search volume" },
      { k: "Free", v: "No paid tier" },
    ],
  },
  intro: {
    problem: [
  ...
  whatCovers: {
    title: "What the Newsletter",
    titleHighlight: "Covers",
    items: [
      {
        icon: "RefreshCw",
      ...
      {
        icon: "Search",
        title: "SEO and Organic Search Intelligence",
        body: "Confirmed and suspected Google algorithm updates and ranking pattern changes; changes to how Google presents search results (new SERP features, AI Overviews behaviour, featured snippet format changes) and their impact on organic click-through rates; E-E-A-T signal developments and content quality standards; and specific technical SEO changes most likely to affect site performance.",
      },
      {
        icon: "DollarSign",
      ...
      {
        icon: "Cpu",
        title: "AI and Automation Intelligence",
        body: "New AI tools and capabilities with honest assessments of their practical value for marketing programmes (not every AI tool that generates headlines produces commercial value). Specific AI applications most likely to produce productivity and quality improvements in content production, paid advertising, and SEO automation. Implications of AI search (Google AI Overviews, Bing Copilot, Perplexity) for organic visibility.",
      },
      {
        icon: "ShoppingCart",
        title: "E-Commerce and Platform Intelligence",
        body: "Platform updates from Shopify, WooCommerce, Magento, and the headless commerce ecosystem. Amazon algorithm and advertising changes. Social commerce developments on TikTok Shop, Instagram Shopping, and Pinterest. DTC brand marketing developments most likely to affect consumer goods businesses across our primary markets.",
      },
      {
        icon: "Globe",
  ...
  difference: {
    title: "What Makes the Clickmasters Newsletter",
  ...
  testimonials: [
    ...
    {
      quote: "The AI marketing coverage is the best I have found anywhere. Clickmasters understands the difference between AI that actually improves marketing outcomes and AI that generates hype. That distinction is increasingly valuable.",
      author: "Marketing Director",
      company: "SaaS Company",
      location: "Austin, USA",
    },
    {
      quote: "The multi-market perspective is what makes this newsletter uniquely valuable for us. We run programmes in the UK and UAE simultaneously, and most newsletters are US-centric in a way that makes them only partially relevant. Clickmasters covers the markets we actually operate in.",
      author: "Regional CMO",
  ...
  archive: {
    ...
    issues: [
      ...
      {
        title: "The AI Overviews Impact Report: 12 Months of Click-Through Rate Data",
        description: "Analysis of how Google AI Overviews have affected organic click-through rates across 200 tracked keyword clusters over 12 months, with specific findings by query type, industry sector, and SERP feature combination.",
      },
      {
        title: "LinkedIn Algorithm 2026: What the Data Shows About Organic Reach",
        description: "A data analysis of LinkedIn content reach patterns across 35 monitored company pages and personal profiles, identifying the content types, posting cadences, and engagement patterns producing above-average organic reach in the current algorithm.",
      },
    ],
    archiveLink: "https://clickmastersdigitalmarketing.com/blog/",
  },
  subscribe: {
    title: "Subscribe Free",
    description: "The newsletter is free. There is no paid tier, no premium access, and no content withheld for upgrade purposes. The full issue goes to every subscriber every week.",
