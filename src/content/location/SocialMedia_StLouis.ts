...
export const SocialMedia_StLouis = {
  ...
  formula: `BAB  St. Louis Boeing BDS aerospace engineering LinkedIn + Edward Jones FINRA financial advisor community + The Hill/Soulard/Cherokee authentic neighbourhood brand → ITAR-bounded defence aerospace LinkedIn + FINRA-compliant financial professional community + authentic St. Louis neighbourhood consumer social`,
...
BOEING BDS AEROSPACE ENGINEERING LINKEDIN: Boeing Defense, Space & Security's Hazelwood campus creates a LinkedIn aerospace engineering and programme management community evaluating vendor content against the institutional precision of a top-5 US defence prime contractor. Defence technology vendors, aerospace services companies, and professional services businesses competing for Boeing BDS consideration need LinkedIn thought leadership demonstrating genuine ITAR-bounded defence aerospace operational vocabulary: AS9100D quality management operational insights, DCAA compliance operational specifics, DoD supply chain resilience analysis, and F/A-18/Apache/SLS programme-adjacent operational content in publicly releasable terms. Generic 'aerospace technology' LinkedIn earns zero engagement from Hazelwood's most commercially sophisticated engineering community.

EDWARD JONES FINANCIAL ADVISOR COMMUNITY LINKEDIN: Edward Jones' Creve Coeur headquarters creates a financial advisor and financial technology LinkedIn community with FINRA Rule 2210 compliance requirements. Financial technology vendors building LinkedIn presence targeting Edward Jones need FINRA-compliant investment content throughout  and the specific financial advisor productivity and wealth management platform vocabulary that Edward Jones's Creve Coeur technology community evaluates.
...
Results (7 months): Boeing BDS supply chain connections: +8 | Boeing BDS programme management: +6 | ITAR: clean throughout | AS9100D content: Boeing BDS community cited as 'first St. Louis quality vendor with genuine AS9100D Revision D operational specificity' | Evaluations: 3/quarter | Pipeline: \$1.6M

Case Study 2: Creve Coeur Financial Technology  Edward Jones FINRA LinkedIn
Client: Wealth management SaaS, Creve Coeur (\$7.4M ARR). Challenge: Generic fintech LinkedIn below Edward Jones FINRA standard. Non-FINRA content.
Programme: FINRA-compliant LinkedIn content + Edward Jones advisor platform vocabulary + Centene managed care community + FINRA review
Results (6 months): Edward Jones fintech connections: +8 | Centene technology connections: +4 | FINRA/SEC: clean | Evaluations: 3/quarter | Pipeline: \$1.2M

Case Study 3: Soulard Food Brand  Authentic Gateway City Social
...
Clayton, Creve Coeur, Hazelwood, Soulard, The Hill, and all of Greater St. Louis`,
  internalLinks: ["/social-media-management-services/","/locations/digital-marketing-agency-st-louis/","/search-engine-optimization/locations/seo-services-st-louis/","/social-media-marketing/locations/social-media-marketing-chicago/"],
