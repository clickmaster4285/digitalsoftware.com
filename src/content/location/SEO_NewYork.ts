...
// Service: SEO
// City: NewYork
// Generated: 2026-06-19T11:58:15.807Z
...
Programme: Technical SEO audit and remediation (JavaScript rendering issues suppressing 40% of pages from indexing) + keyword strategy (18 commercial B2B intent clusters) + pillar content programme (24 pieces in 14 months) + link building (9 editorial placements in B2B publications, 3 mentions in TechCrunch and VentureBeat)
Results (14 months):
- Organic sessions: 0 → 28,400/month
- Organic qualified leads: 0 → 312% above initial baseline by month 14
- Domain Rating: 8 → 44
- Position 1-3 rankings: 22 commercial B2B keywords
...
Programme: SEO + content programme (thought leadership for corporate strategy, operational excellence, and digital transformation searches) + LinkedIn amplification + Wall Street Journal HARO placement
Results (10 months):
- Page 1 rankings: 18 commercial consulting keywords
- Organic sessions: 0 → 9,800/month
- Inbound enquiries from organic: 0 → 14/month
...
Programme: E-commerce SEO (product category pages, buying guide content, review schema) + link building from lifestyle and design publications + page speed optimisation (LCP 6.8s → 1.9s)
Results (12 months):
- Organic revenue: +218%
- Organic sessions: 4,200 → 38,600/month
