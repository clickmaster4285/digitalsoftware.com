...
// Generated: 2026-06-20T06:13:02.292Z
...
export const SEO_NewOrleans = {
  ...
  formula: `BAB — New Orleans SEO = Ochsner Health/Tulane/LSU Health YMYL gap + Entergy/Shell energy B2B gap + Port of New Orleans maritime logistics gap + hospitality convention B2B gap + Louisiana data breach law → academic YMYL + energy B2B + maritime logistics + hospitality tech + Louisiana compliance`,
...
OCHSNER HEALTH AND TULANE/LSU HEALTH YMYL SEO: Ochsner Health System — Louisiana's largest health system, recognised nationally for cardiac and oncology — and Tulane University School of Medicine (one of the US's oldest medical schools, founded 1834) define the YMYL academic medical content standard in the greater New Orleans market. Health technology vendors and healthcare practices competing in the New Orleans healthcare market need organic content demonstrating Ochsner Health clinical vocabulary, Tulane School of Medicine academic research community, LSU Health Sciences Center New Orleans clinical programme, and the Louisiana YMYL academic healthcare content that earns genuine Ochsner and Tulane procurement organic discovery.

ENTERGY CORPORATION ENERGY B2B SEO: Entergy Corporation — headquartered in New Orleans, serving 3 million customers across Arkansas, Louisiana, Mississippi, and Texas — creates utility technology and energy infrastructure B2B organic search opportunities. Technology vendors competing for Entergy procurement need content demonstrating Entergy's operational vocabulary: utility grid modernisation, rate case regulatory vocabulary, transmission and distribution technology, and the energy utility operational intelligence that Entergy New Orleans technology procurement evaluates.

PORT OF NEW ORLEANS MARITIME LOGISTICS SEO: The Port of New Orleans — one of the US's busiest ports by tonnage and the largest US port for coffee, rubber, and steel imports — creates maritime logistics, supply chain technology, and port operations B2B organic search opportunities.
...
Results (11 months): Page 1 for 10 New Orleans health IT queries | Ochsner VP: organic discovery | Tulane: community engaged | YMYL: E-E-A-T | Pipeline: \$1.4M

Case Study 2: New Orleans Energy Technology — Entergy Grid B2B SEO
Client: Utility technology SaaS, New Orleans (\$5.4M ARR). Challenge: Zero Entergy grid vocabulary. Entergy procurement not finding.
Programme: Entergy grid modernisation vocabulary + rate case regulatory content + GEO/AEO
Results (10 months): Page 1 for 9 New Orleans energy tech queries | Entergy: evaluation entered | Pipeline: \$1.2M

Case Study 3: New Orleans Logistics Technology — Port Maritime B2B SEO
...
1. Ochsner/Tulane YMYL vocabulary gap — academic medical searches you're missing
2. HIPAA compliance in clinical content
3. Entergy energy vocabulary — grid modernisation B2B content gaps
4. Port of New Orleans maritime — shipping logistics vocabulary
...
Metairie, Garden District, Uptown, and all of Greater New Orleans`,
  internalLinks: ["/seo-services/","/digital-marketing-agency-in-new-orleans/","/seo-services-houston/","/seo-services-atlanta/"],
