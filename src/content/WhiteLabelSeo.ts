export const WhiteLabelSeoContent = {
  ...
  hero: {
    ...
    stats: [
      ...
      { k: "40+", v: "Clients per agency (case)" },
      { k: "10+ yrs", v: "White label expertise" },
    ],
  },
  intro: {
    problem: [
      { text: "There is a better model. It is called white label SEO, and it is how the ", type: "normal" },
      { text: "most profitable digital agencies", type: "highlight" },
    ...
    solution: [
      ...
      { text: " Your clients get results that deepen their trust in you.", type: "normal" }
    ],
    promise: [
  ...
  services: [
    {
      ...
      blocks: [
        ...
        {
          h: "On-Page SEO",
          p: "Keyword research and intent mapping, title tag and meta description optimization, heading structure optimization, content depth analysis, E-E-A-T signal building, URL structure review, and internal link architecture reconstruction.",
        },
        {
        ...
        },
        {
          ...
          p: "White-hat link building through digital PR, resource page outreach, broken link building, expert commentary, and guest posting on pre-qualified publications (DR 40+). No PBNs, no link farms. Monthly link reports formatted for client presentation.",
        },
        {
          h: "Local SEO",
      ...
      blocks: [
        {
          ...
          p: "Keyword ranking movement with trend charts, organic traffic metrics from GA4, technical SEO health score, link acquisition summary with domain authority distribution, content performance, and next-month strategic action plan.",
        },
        {
      ...
      blocks: [
        {
          ...
          p: "You close the SEO engagement. Notify your Clickmasters account manager with client brief (website, industry, target keywords, geographic market, goals). We don't participate in your client pitch, pricing, or proposal.",
        },
        {
        ...
        },
        {
          ...
          p: "Campaign execution during weeks 1-3, weekly internal updates to your agency, month-end branded report delivery by agreed deadline, ready for your client presentation schedule.",
        },
      ],
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          p: "When your agency needs to propose SEO strategy or present renewal recommendations, we provide technical depth and campaign projections. We brief your team; you present.",
        },
        {
      ...
      blocks: [
        {
          ...
          p: "Wholesale rates allowing agency partners to apply standard markup of 30-100% and remain competitively priced. Pricing determined by service scope, number of accounts, and volume commitment level.",
        },
        {
          h: "Volume Discounts",
        ...
        },
        {
          ...
          p: "No minimum contract lengths on individual client engagements. If your client cancels, you cancel the white label campaign without penalty. We earn your continued business by delivering results that keep clients retained.",
        },
      ],
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          p: "Topic cluster content architecture, product feature optimization, integration and comparison pages, B2B link building through industry publication placement. Reporting focused on organic pipeline contribution.",
        },
        {
  ...
  cases: [
    {
      tag: "Design Agency · 2-person studio",
      metric: "$180K",
    ...
    {
      tag: "Marketing Agency · Scaling success",
      metric: "40",
  ...
  why: [
    ...
    {
      icon: "Star",
      h: "Consistent quality at volume",
      p: "We maintain consistent quality across entire white label portfolio through standardized processes, QA reviews on every deliverable, and dedicated account management providing continuity across your agency's entire client portfolio.",
    },
    {
      icon: "Layout",
      h: "Fully branded deliverables from day one",
      p: "We build your branded templates once and use them for every deliverable produced for your agency's clients from campaign day one. Every audit, report, dashboard, and strategy document looks like your agency's native work.",
    },
    {
      icon: "Cpu",
  ...
  faqs: [
    ...
    },
    {
      ...
      a: "Campaign setup begins within 48 hours of receiving client brief and access credentials. Full technical audit completed within 5-7 business days. First branded strategy presentation ready within 10-14 business days. For time-sensitive client start dates, we can accelerate audit timeline with advance notice.",
    },
    {
    ...
    },
    {
      ...
      a: "We identify the cause, escalate internally, develop a recovery plan, and provide your account manager with a full briefing on corrective action and timeline. We do not leave your agency to explain poor results without our full support behind the scenes.",
    },
    {
      q: "How many white label SEO clients can you manage for a single agency?",
      a: "No upper limit. Our largest agency partner manages 40+ white label SEO clients. We scale team resource allocation to match your portfolio growth so adding new clients does not degrade existing campaign delivery.",
    },
    {
      q: "Can I offer white label SEO for clients in any industry?",
      a: "Yes. We cover all major industries with specific competencies in healthcare (HIPAA-aware), legal (Bar rule-compliant), financial services (FINRA-aligned), e-commerce, SaaS, local services, hospitality, and real estate.",
    },
    {
      q: "What is the minimum number of clients required to start a white label partnership?",
      a: "No minimum. We have agency partners who started with a single client. Volume pricing benefits and dedicated account manager model become most commercially meaningful with three or more active clients.",
    },
    {
