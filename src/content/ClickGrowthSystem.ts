export const ClickGrowthSystemContent = {
  slug: "click-growth-system",
  metadata: {
    url: "/click-growth-system/",
    keyword: "revenue growth marketing framework",
    volume: "2,900/mo",
    cpc: "$12.40",
    formula: "AIDA",
    author: "Amjad Khan",
  ...
  hero: {
    ...
    stats: [
      ...
      { k: "340%", v: "Traffic growth achieved" },
      { k: "AED 32.8K", v: "Monthly email revenue" },
    ],
  },
  intro: {
    problem: [
  ...
  clickStages: [
    {
      ...
      channels: [
        ...
        "LinkedIn advertising for B2B technology and professional services firms",
      ],
    },
    {
      letter: "L",
      ...
      components: [
        ...
        "Local conversion infrastructure: GBP optimisation for Local Pack visibility",
        "Contact friction reduction: every additional field or click reduces conversion rate",
      ],
    },
    {
      letter: "I",
      ...
      dimensions: [
        "Authority content: thought leadership, case studies, expert guides demonstrating genuine expertise",
        "Social proof: reviews, testimonials, case studies, third-party recognition (certifications, awards)",
        "Retargeting and nurture: paid advertising and email re-engaging visitors who didn't enquire",
      ],
    },
    {
      letter: "C",
      ...
      components: [
        ...
        "Nurture sequences: email sequences delivering relevant content throughout extended evaluation periods",
      ],
    },
    {
      letter: "K",
      ...
      components: [
        ...
        "Upsell and cross-sell programmes: targeted communication about complementary services",
        "Client success content: guides, updates, case studies that deepen engagement and reduce churn",
      ],
    },
  ],
  process: {
    title: "How the CLICK Growth System Structures Every Client Programme",
    stages: [
      {
        name: "The Audit Stage",
        description:
          "Every Clickmasters engagement begins with an audit of the client's current position across all five CLICK stages. A business with strong Capture but weak Lead has different programme priorities from a business with strong Lead but weak Capture. The CLICK audit maps the gaps before the programme is designed.",
      },
      {
      ...
      },
      {
        ...
        description:
          "The programme is implemented with the commercial metrics of each CLICK stage as primary performance indicators: traffic volume and quality (Capture), lead conversion rate and cost per lead (Lead), content engagement and retargeting performance (Influence), lead-to-client conversion rate (Convert), and client retention rate and referral volume (Keep).",
      },
      {
  ...
  cases: [
    {
      tag: "UK · Professional Services",
      metric: "340%",
      sub: "traffic growth · 2.1% → 4.8% conversion",
      title: "UK professional services firm closes gaps in Capture and Lead.",
      body: "A UK management consultancy had strong Keep and Convert but weak Capture and Lead. CLICK audit identified primary gaps. Programme response: SEO content programme for Capture, landing page rebuild and CRO for Lead. Within 12 months, organic traffic grew 340%, lead-to-enquiry conversion improved from 2.1% to 4.8%, monthly qualified enquiries grew from 6 to 28.",
    },
    {
