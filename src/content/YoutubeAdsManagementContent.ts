export const YoutubeAdsManagementContent = {
  ...
  hero: {
    ...
    stats: [
      ...
      { k: "3.6x", v: "ROAS achieved (client example)" },
      { k: "$0.03–0.30", v: "typical cost-per-view" },
    ],
  },
  intro: {
    problem: [
  ...
  problem: {
    ...
    items: [
      ...
      },
      {
        ...
        body: "Video earns a quality of attention that no other ad format can match. A text ad in a search result is read in half a second. A banner ad is peripherally registered. A 30-second video ad is watched, listened to, and processed at a depth that produces significantly stronger brand recall, message comprehension, and purchase intent than equivalent text or display advertising. For products that benefit from demonstration, for brands building emotional connection, and for offers that require explanation, video is the only format that achieves the full communication objective.",
      },
      {
        icon: "DollarSign",
  ...
  adFormats: {
    ...
    formats: [
      ...
      {
        icon: "Square",
        title: "Bumper Ads (6 seconds)",
        description: "6-second, non-skippable ads optimized for brand recall and message reinforcement rather than complex storytelling. The 6-second constraint demands extreme creative discipline. Best for: reinforcing awareness generated by longer-form ads, frequency management (delivering brand touchpoints at very low CPMs), and sequential retargeting.",
      },
      {
        icon: "List",
  ...
  creativeFramework: {
    title: "The ABCD Creative Framework",
    titleHighlight: "For YouTube",
    items: [
      {
        letter: "A",
        word: "Attention",
        description: "Capture interest in the first 5 seconds. Use bold visuals, a provocative question, a specific pain point the audience immediately recognizes, or a disruptive visual element that breaks from the surrounding content environment.",
      },
      {
        letter: "B",
        word: "Branding",
      ...
      },
      {
        letter: "C",
        word: "Connection",
        description: "Create an emotional or rational connection between the viewer and the message. For B2B ads, this means specific, accurate descriptions of the professional challenges the audience faces. For B2C ads, this means aspirational, empathetic, or entertaining content that resonates with the audience's identity or desires.",
      },
      {
        letter: "D",
        word: "Direction",
        description: "End with a specific, clear call to action. YouTube Ads that tell viewers exactly what to do next consistently achieve higher post-view conversion rates than those that leave the next step ambiguous.",
      },
    ],
  },
  measurement: {
    ...
    metrics: [
      {
        title: "View-Through Metrics",
        description: "Views, view rate (percentage of ad impressions resulting in a view), CPV (cost per view), and video completion rate (percentage who watched 25%, 50%, 75%, or 100% of the ad). These measure creative effectiveness and are the primary optimization signal for brand awareness campaigns.",
      },
      {
        title: "Click-Through and Website Metrics",
        description: "Click-through rate from YouTube ads to your website, website visits, pages per session, and time on site for YouTube-originating traffic. These measure how effectively the ad motivates immediate action and how well the landing page converts YouTube traffic.",
      },
      {
        title: "Conversion and Revenue Metrics",
        description: "View-through conversions (conversions within a window after seeing a YouTube ad without clicking), click-through conversions, cost-per-conversion, and ROAS for e-commerce campaigns. YouTube's view-through conversion window acknowledges that YouTube Ads frequently influence purchases that do not occur through a direct ad click.",
      },
      {
  ...
  process: {
    title: "Our YouTube Ads Management",
    titleHighlight: "Process",
    steps: [
      {
        days: "Week 1–2",
        title: "Audit and strategy",
        description: "Existing accounts: audit of campaign structure, targeting, creative performance (view rate, completion rates, CTRs), conversion tracking, and audience configuration. New accounts: audience research and Custom Intent keyword development, campaign structure design, creative brief development for all required ad formats, and 90-day campaign roadmap.",
      },
      {
        days: "Week 3–4",
        title: "Implementation",
        description: "Campaign build in Google Ads. Custom Intent audience list construction. YouTube channel and placement targeting list build. Remarketing audience configuration. Creative upload and ad group organization. Conversion tracking verification including view-through conversion window configuration.",
      },
      {
        days: "Month 2",
        title: "Launch and performance monitoring",
        description: "Campaigns launch. Daily monitoring for impression delivery, CPV anomalies, and budget pacing. Weekly creative performance review (view rates, completion rates, CTRs by creative variation). Audience segment performance differentiation.",
      },
      {
        days: "Month 3–4",
        title: "Optimization and creative refresh",
        description: "Creative testing based on view rate and conversion data. Audience expansion or refinement based on performance signals. Introduction of new creative formats for funnel variation. Remarketing audience build from campaign exposure data.",
      },
      {
        days: "Month 5+",
        title: "Funnel integration and scaling",
        description: "YouTube remarketing sequences fully operational. Integration with Google Search and Display campaigns for cross-channel attribution. Scaling proven creative and audience combinations. Monthly reporting connecting YouTube Ads investment to brand metrics, pipeline contribution, and revenue outcomes.",
      },
    ],
  },
  cases: [
    {
      tag: "B2B Software · Full-Funnel",
      metric: "38%",
    ...
    },
    {
      ...
      metric: "3.6x",
      sub: "ROAS · $145K monthly revenue",
      title: "E-commerce home decor brand achieves 3.6x ROAS from YouTube Ads in 4 months.",
      body: "A premium home decor e-commerce brand was running Google Shopping and Meta Ads effectively but had never tested YouTube. Their strong product photography provided raw material for video production. Our YouTube campaign: 30-second In-Stream Skippable Ads showing product styling scenarios for In-Market Home Decor audiences, 15-second Non-Skippable Ads for remarketing to website visitors and cart abandoners, and Performance Max campaigns with YouTube video assets alongside the Shopping product feed.",
      result: "YouTube Ads achieved a 3.6x ROAS within 4 months. YouTube-attributed revenue reached $145,000 per month. The creative assets developed for YouTube were subsequently repurposed for Instagram Reels and TikTok, extending the ROI of the video production investment across three channels simultaneously.",
    },
    {
      tag: "Local Service · Brand Awareness",
      metric: "34%",
  ...
  why: [
    ...
    {
      icon: "LineChart",
      h: "Transparent attribution including view-through",
      p: "YouTube's contribution to revenue is frequently underreported in last-click attribution models because YouTube often influences purchases that complete through other channels. We implement view-through conversion tracking, configure cross-channel attribution in GA4, and ensure YouTube's full contribution to pipeline and revenue is visible in reporting.",
    },
  ],
  faqs: [
    {
      q: "How much does YouTube advertising cost?",
      a: "YouTube Ads costs depend on the campaign format, targeting, and competitive bidding environment. In-Stream Skippable Ads (TrueView) typically cost $0.03 to $0.30 per view (CPV) in most markets. Non-Skippable Ads are priced on a CPM basis, typically $10 to $30 per 1,000 impressions. Bumper Ads are priced at CPM, typically $5 to $20 per 1,000 impressions. Effective optimization for conversion objectives typically requires $1,500 to $5,000 per month minimum. We provide a specific budget recommendation based on your business goals after an initial discovery call.",
    },
    {
    ...
    },
    {
      ...
      a: "YouTube attribution requires a multi-touch measurement approach because YouTube often influences purchases that complete through other channels. We configure view-through conversion windows appropriate to your sales cycle length, implement GA4 cross-channel attribution, use Brand Lift studies for larger campaigns, and reconcile YouTube-attributed revenue with CRM pipeline data for B2B businesses. UTM parameters on all YouTube destination URLs track YouTube traffic quality in GA4.",
    },
    {
    ...
    },
    {
      ...
      a: "Book a free YouTube Ads audit. We review any existing YouTube or Google Ads campaigns, assess your current video creative assets, evaluate your conversion tracking setup, and identify the specific targeting strategy and creative approach most likely to produce results for your business. No commitment required at the audit stage.",
    },
  ],
  cta: {
