export const SocialMediaMarketingContent = {
  ...
  hero: {
    ...
    stats: [
      { k: "5B+", v: "Global social media users" },
      { k: "4,200%", v: "Follower growth achieved" },
      { k: "$580K", v: "Inbound pipeline from LinkedIn" },
      { k: "10+ yrs", v: "Social media expertise" },
    ],
  },
  intro: {
    problem: [
  ...
  problem: {
    ...
    titleHighlight: "Achieves in 2026",
    items: [
      {
        icon: "Megaphone",
  ...
  services: [
    {
      ...
      blocks: [
        {
          h: "Facebook Page Management",
          p: "We manage Facebook business pages with a content strategy focused on native video (particularly Reels), long-form post content that generates meaningful comments and shares, community-building posts, and local/event-based content.",
        },
        {
        ...
        },
        {
          ...
          p: "Organic content that performs well becomes strong creative material for paid amplification. We track organic content performance and boost content that has already demonstrated audience appeal with targeted paid spend.",
        },
      ],
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          p: "For e-commerce brands, we set up and manage Instagram Shopping catalogs, product tagging workflows, and product discovery content strategies that drive Shopping click-through and revenue.",
        },
      ],
    },
    {
      ...
      blocks: [
        {
          ...
          p: "We manage LinkedIn company pages with a focus on thought leadership and industry insight. Personal profiles reach 5-10x more organic users than company pages, so we develop executive personal profile content strategies for founders and key leaders.",
        },
        {
          h: "LinkedIn Articles and Newsletters",
          p: "LinkedIn's long-form article format and newsletter feature reach members' inboxes directly. We develop article and newsletter programs for clients with genuine expert insight to share.",
        },
        {
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          p: "Users increasingly search TikTok for product reviews and tutorials. We integrate TikTok search strategy into content planning and manage TikTok Shop integration for e-commerce brands.",
        },
      ],
    },
    {
      ...
      blocks: [
        {
          h: "X Content Strategy",
          p: "Participating in industry conversations, original thought leadership threads, audience engagement (responding to mentions), and content amplification (sharing blog posts, research, and news with platform-appropriate framing).",
        },
      ],
    },
    {
      ...
      icon: "BarChart3",
      tag: "Analytics",
      title: "Performance Reporting and Social Listening",
      intro:
        "Monthly reports cover follower growth, reach and impression volume, engagement rate, website traffic from social channels, and direct lead or sales attribution from social content.",
      blocks: [
        {
        ...
        },
        {
          ...
          p: "We monitor brand mentions across platforms, track what is being said about the brand, identify emerging customer concerns before they become crises, and monitor competitor social media activity for strategic insights.",
        },
      ],
    },
  ],
  cases: [
    {
      tag: "Dental Practice · Local Social",
      metric: "4,200%",
      sub: "follower growth · 180 → 7,730",
      title: "Dental practice group achieves 4,200% Instagram following growth in 18 months.",
      body: "A five-location dental group in Houston had 180 Instagram followers and no content strategy. Our 18-month program: Instagram-first strategy featuring patient transformation content, educational dental content, behind-the-scenes team content, and promotional content. Result: Instagram grew from 180 to 7,730 followers, engagement rate above 4.5% (benchmark 1.8%), social media became the second-largest source of new patient inquiries after Google Search, contributing 34 new patient leads per month.",
    },
    {
      tag: "B2B Tech · LinkedIn",
      metric: "$580K",
      sub: "inbound pipeline · 1,200 → 9,800 followers",
      title: "B2B technology company LinkedIn thought leadership generates $580K in inbound pipeline.",
      body: "A cybersecurity software company had minimal inbound from organic channels. Our LinkedIn program: company page transformation, CEO personal profile thought leadership, and LinkedIn Newsletter. Result: Company page followers grew from 1,200 to 9,800 in 12 months, CEO posts averaged 18,000 impressions, Newsletter reached 3,200 subscribers, inbound pipeline reached $580,000 at zero direct advertising cost.",
    },
    {
      tag: "E-commerce Fashion · TikTok",
      metric: "$45K",
      sub: "monthly revenue · 0 → 22K followers",
      title: "E-commerce fashion brand TikTok drives 280,000 monthly views and $45,000 in monthly revenue.",
      body: "A sustainable fashion brand had strong Instagram but no TikTok strategy. Our program: behind-the-scenes sustainable production content, outfit-of-the-day styling, sustainability education, and trend participation. Result: TikTok grew from zero to 22,000 followers in 8 months, average monthly views reached 280,000, TikTok generated $45,000 monthly revenue through TikTok Shop, and content repurposed for Instagram Reels improved Instagram organic reach by 160%.",
    },
  ],
  why: [
    {
    ...
    {
      icon: "ShieldCheck",
      h: "Compliant content for regulated industries",
      p: "Social media for healthcare must respect HIPAA. For law firms, Bar advertising rules. For financial services, FINRA compliance. We produce content that achieves maximum engagement within specific compliance constraints.",
    },
  ],
  faqs: [
    {
      q: "How many social media platforms should my business be on?",
      a: "Being on three platforms with a consistent, high-quality presence is significantly more effective than being on seven platforms with sporadic, low-quality content. Local service businesses should prioritize Facebook and Instagram. B2B businesses should prioritize LinkedIn and potentially X. E-commerce and consumer brands should prioritize Instagram and TikTok. We recommend starting with two to three platforms and expanding as resources and results justify.",
    },
    {
    ...
    },
    {
      ...
      a: "LinkedIn: 3-5 times per week for company pages, daily for active personal profiles. Instagram: 4-7 feed posts or Reels per week, daily Stories. Facebook: 3-5 times per week. TikTok: 5-7 times per week for accounts building audience from scratch. X: 3-10 times per day for active industry presence. Content quality consistently matters more than posting frequency.",
    },
    {
    ...
    },
    {
      ...
      a: "For lead generation businesses, we track website traffic from social channels, form submissions attributed to social referrals, and direct lead capture. For e-commerce businesses, we track social-attributed revenue through GA4 and social shopping analytics. For brand awareness objectives, we track reach, impressions, follower growth, and engagement rate. We use multi-touch attribution analysis to represent social media's full contribution to revenue.",
    },
    {
    ...
    },
    {
      ...
      a: "Book a free social media audit. We review your current social media presence across all active platforms, evaluate your content performance and engagement rates, benchmark your audience size and growth against industry competitors, and identify the top five specific improvements most likely to produce meaningful results. No commitment required.",
    },
  ],
  cta: {
