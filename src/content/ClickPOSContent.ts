export const ClickPOSContent = {
  ...
  hero: {
    ...
    stats: [
      ...
      { k: "73%", v: "Ticket error reduction" },
      { k: "49,500/mo", v: "Primary keyword volume" },
    ],
  },
  intro: {
    problem: [
  ...
  problem: {
    ...
    afterItems: [
      {
        icon: "Building",
        title: "A POS That Runs the Business, Not Just the Till",
        body: "ClickPOS is an integrated business management platform: real-time inventory tracking stock levels of every SKU across every location, staff management tracking hours and commissions, customer database maintaining purchase history and loyalty points, and management dashboards putting complete operational picture in the owner's hands from any device.",
      },
      {
        icon: "Shield",
  ...
  features: [
      ...
      blocks: [
        {
          ...
          p: "Unlimited variant matrices (size, colour, style, or any combination of attributes), barcode scanning for fast transaction entry, product lookup by name, SKU, barcode, or attribute. Multi-location stock management maintains accurate inventory across unlimited locations simultaneously. Inter-store stock transfers managed within ClickPOS.",
        },
        {
          h: "Promotional Mechanics",
          p: "Percentage and fixed-value discounts (line item or basket level), multi-buy promotions (buy two get one free, three for the price of two), loyalty point accumulation and redemption, staff discount tiers, promotional voucher codes, and time-limited flash promotions activated and deactivated centrally across all locations.",
        },
      ],
    },
    {
      ...
      icon: "Utensils",
      tag: "Hospitality",
      title: "Restaurant and Hospitality POS",
      intro: "Built for table service, quick service, and bar service workflows that hospitality businesses actually operate.",
      blocks: [
        {
      ...
      blocks: [
        {
          ...
          p: "Bookings created in appointment module (or synced from online booking widget), appointment generates pre-populated transaction at check-out, payment processed against appointment record with staff commission recorded automatically. Automated SMS and email reminders reducing no-show rate.",
        },
        {
    ...
    },
    {
      ...
      intro: "Real-time stock control and purchase order management that closes the inventory loop.",
      blocks: [
        {
        ...
        },
        {
          ...
          p: "Reorder alerts triggered when stock falls below configured reorder point. Purchase orders raised to supplier. Goods receipt updates inventory when delivery arrives. Complete procurement workflow from alert to order to receipt.",
        },
      ],
    },
    {
      ...
      intro: "Real-time dashboards and structured analysis that operational management requires.",
      blocks: [
        {
        ...
        },
        {
          ...
          p: "Sales by product, category, and promotion. Staff performance analysis (transaction count, average value, upsell rate). Hourly and weekly traffic patterns identifying peak periods. Customer analytics (retention rate, transaction frequency, loyalty performance) informing retention marketing.",
        },
      ],
    },
    {
      ...
      icon: "HeartHandshake",
      tag: "Loyalty",
      title: "Customer Loyalty and CRM",
      intro: "Integrated loyalty programme and customer database growing the relationship value over time.",
      blocks: [
        {
          h: "Loyalty Programme",
  ...
  why: [
    ...
    },
    {
      ...
      p: "ClickPOS operates on iPad, Android tablets, and dedicated touchscreen terminals. Supports receipt printers, cash drawers, barcode scanners, card payment terminals, and kitchen display screens. We supply and configure complete hardware bundles or integrate with compatible existing hardware.",
    },
    {
      icon: "Network",
      h: "Multi-location centralised management",
      p: "For multi-location businesses, ClickPOS provides estate-level view: comparative performance across all locations, centralised menu and product management (push updates to all locations simultaneously), centralised promotions, consolidated reporting without manually aggregating location-level reports.",
    },
    {
      icon: "CreditCard",
      h: "Payment processing integration",
      p: "ClickPOS integrates with Stripe, Square, PayPoint, Worldpay, Adyen, and local processors in UAE (Network International, Mashreq) and Pakistan (HBL Konnect, Easypaisa). Contactless, chip-and-PIN, Apple Pay, Google Pay, and QR code payments supported.",
    },
  ],
  faqs: [
    {
      q: "What is a POS system and what does ClickPOS do?",
      a: "A point of sale (POS) system is the software and hardware that processes transactions at the point where goods or services are sold to customers. ClickPOS is a cloud-based POS that goes beyond transaction processing to provide: real-time inventory management (tracking stock levels across all locations as each transaction occurs), staff management (hours, performance, commission tracking), customer loyalty programme (automatic points accumulation and redemption), management reporting (real-time and historical analytics by product, staff, and time period), and integrations with accounting software, e-commerce platforms, and ClickERP.",
    },
    {
      q: "Which types of businesses does ClickPOS serve?",
      a: "ClickPOS serves three primary business categories: retail (fashion, beauty, electronics, food and beverage retail, specialty retail), food service and hospitality (cafés, restaurants, quick service, bars, hotels, event venues), and service businesses (salons, spas, clinics, gyms, repair services). Each category has a specific ClickPOS module configuration with workflow defaults, terminology, and features appropriate for the business type. We also serve hybrid businesses where multiple ClickPOS modules operate within the same system.",
    },
    {
    ...
    },
    {
      ...
      a: "ClickPOS is compatible with iPad (9th generation and later, iPad Mini, Air, Pro), Android tablets (Samsung Galaxy Tab A7 and later), and Windows touchscreen terminals. Peripheral hardware includes receipt printers (Star Micronics, Epson series), cash drawers (connected via receipt printer), barcode scanners (USB and Bluetooth), kitchen display systems (dedicated KDS screens), and card payment terminals (via integrated payment processor partners). We supply complete hardware bundles with configuration pre-loaded before delivery.",
    },
    {
      q: "How does ClickPOS integrate with accounting software?",
      a: "ClickPOS integrates with Xero, QuickBooks, Sage, and FreeAgent via direct API integration: daily sales totals pushed at end of day (configurable timing), categorised by revenue type (product sales, service revenue, tips, promotional discounts) and payment method (cash, card, contactless, voucher). Integration eliminates manual re-entry, reduces reconciliation discrepancies, ensures management accounts are always current. For businesses using ClickERP, the ClickPOS-ClickERP integration provides deeper financial integration.",
    },
    {
