export const PodcastMarketingServicesContent = {
  ...
  hero: {
    ...
    stats: [
      ...
      { k: "$8.4M", v: "Series A supported" },
      { k: "20%", v: "Podcasts with >10 episodes" },
    ],
  },
  intro: {
    problem: [
  ...
  whyPodcast: {
    ...
    titleHighlight: "Underutilised B2B Marketing Channel",
    items: [
      {
        icon: "Heart",
      ...
      {
        icon: "Database",
        title: "The Compounding Asset Dynamic",
        body: "Unlike paid advertising (which stops generating results the moment spend stops), a podcast's back catalogue is a permanent, discoverable, compounding asset. An episode published two years ago is still findable, still playable, and still converting new listeners. A podcast with 150 episodes is 150 entry points into the audience relationship, each one permanently available to the prospective listener who discovers the show for the first time today.",
      },
      {
        icon: "Share2",
      ...
      {
        icon: "Compass",
        title: "The Discoverability Problem Most Podcasters Ignore",
        body: "Discoverability is the primary growth bottleneck for most podcasts. Podcast platforms rank shows based on factors most podcasters never optimize: episode title and description keyword optimization, listener engagement signals (completion rates, follows, ratings), consistency of publication schedule, and authority signals built through cross-platform presence and backlinks. A podcast that does not actively manage its discoverability depends entirely on word-of-mouth for growth.",
      },
    ],
  },
  services: [
      ...
      blocks: [
        {
          ...
          p: "Competitive analysis of existing shows in the target niche, identifying positioning gaps that create competitive advantage, defining show concept, episode format, and content pillars that serve the target listener's specific interests and needs.",
        },
        {
          h: "Show Format and Production Design",
          p: "Guiding format decisions (episode length, interview vs solo vs co-hosted, weekly vs bi-weekly, series vs evergreen) based on audience listening habits, content creation capacity, and competitive landscape. Production quality guidance for equipment, software, recording workflow, and visual identity.",
        },
        {
          h: "Podcast Launch Strategy",
          p: "Launch inventory of 3-5 episodes published simultaneously on launch day, cross-platform promotion push across existing social channels and email list, review and rating campaign for Apple Podcasts' New & Noteworthy placement, and guest episode strategy leveraging existing audiences through early collaboration.",
        },
      ],
    },
    {
      ...
      blocks: [
        {
          ...
          p: "Show title and description optimisation for keyword-relevant search terms, episode title and description optimisation for episodic search queries, category and subcategory selection maximising placement relevance, and ongoing engagement monitoring to address drops affecting algorithmic distribution.",
        },
        {
          h: "Google Podcast SEO and Episode Indexation",
          p: "Episode show notes optimised as standalone articles (substantive content serving search queries relevant to the episode's topic), transcript publication giving Google text content to index, and podcast website optimisation for primary and secondary keyword targets.",
        },
        {
    ...
    },
    {
      ...
      icon: "Repeat",
      tag: "Repurposing",
      title: "Content Repurposing and Cross-Platform Distribution",
      intro: "One well-produced podcast episode systematically repurposed generates a portfolio of derivative content across every platform where the target audience is present.",
      blocks: [
        {
          h: "The Podcast Content Multiplication System",
          p: "Defining specific derivative content types that serve the show's audience and platforms, building production workflows that make repurposing efficient and scalable, and managing distribution calendar keeping the show's content visible across channels between episodes.",
        },
        {
          h: "Audiograms and Social Clips",
          p: "Identifying the most shareable, quotable moments from each episode, producing short-form content optimised for each platform's format and algorithm (vertical video for Reels and TikTok, square and landscape for LinkedIn and X), and scheduling distribution across all relevant platforms.",
        },
        {
          h: "Long-Form Content Repurposing",
          p: "Full blog articles (using transcript as source material), LinkedIn articles or newsletter editions, YouTube videos (full-length episode or audiogram-style), and email newsletter content maintaining subscriber engagement between other communications.",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      icon: "BarChart3",
      tag: "Paid Growth",
      title: "Paid Podcast Promotion and Audience Growth",
      intro: "Strategic paid amplification that accelerates organic growth by reaching targeted audiences who will subscribe and share.",
      blocks: [
        {
        ...
        },
        {
          ...
          p: "Meta Ads and LinkedIn Ads targeting ideal listener demographics with audiogram content and episode trailers, driving traffic to high-converting podcast landing pages capturing follows/subscriptions and email opt-ins. Managing campaigns based on cost-per-new-subscriber data.",
        },
        {
          h: "YouTube Channel Growth for Podcast Video",
          p: "For podcasts with video production, YouTube reaches search-driven audiences that would never discover the audio version. Video SEO for episode titles, descriptions, and tags, thumbnail design maximising CTR, community engagement, and Shorts repurposing driving subscribers to full-length video channel.",
        },
      ],
    },
    {
      ...
      blocks: [
        {
          ...
          p: "Developing podcast-to-business conversion systems: specific calls to action embedded in episodes directing listeners to defined conversion actions, landing pages capturing listener contact information, and email nurture sequences developing the listener relationship after initial contact.",
        },
        {
          h: "Sponsorship and Advertising Revenue",
          p: "Developing sponsor acquisition programs: defining audience profile and engagement metrics attractive to sponsors, creating media kit presenting the show's value, identifying and approaching appropriate sponsors, and structuring sponsorship agreements serving both audience integrity and sponsor objectives.",
        },
        {
  ...
  faqs: [
    ...
    },
    {
      ...
      a: "For professional-quality audio on a reasonable budget: a USB condenser microphone (Audio-Technica AT2020USB+ or Rode NT-USB Mini at $100-$150), basic acoustic treatment (recording in a treated space or closet full of clothes eliminates echo), and audio software (Audacity free; Adobe Audition professional). For video podcasts: mirrorless camera or high-quality webcam (Sony ZV-E10 or Logitech Brio), key light or ring light, and remote recording platform (Riverside.fm or Squadcast). We provide production setup guidance as part of all podcast launch engagements.",
    },
    {
      q: "Should I interview guests or record solo episodes?",
      a: "Both formats serve different purposes. Interview formats are generally better for early-stage audience growth because guests bring their own audiences and lend credibility. Solo episodes are better for brand authority building because they demonstrate specific expertise without a guest filter. Most successful podcasts use a combination: regular guest interviews for growth and discovery, with periodic solo episodes establishing the host's own framework. The optimal mix depends on host's communication style, audience preferences, and specific authority-building objectives.",
    },
    {
