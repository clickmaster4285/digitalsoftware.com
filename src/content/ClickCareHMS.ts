export const ClickCareHMSContent = {
  slug: "clickcare-hms",
  metadata: {
  ...
  hero: {
    ...
    stats: [
      ...
      { k: "58%", v: "Result turnaround improvement" },
      { k: "27,100/mo", v: "Primary keyword volume" },
    ],
  },
  intro: {
    problem: [
      { text: "Most healthcare facilities are managing this complexity on infrastructure that was not designed for it. The human cost is the time that clinical staff spend on paperwork rather than patients. ", type: "normal" },
  ...
  problem: {
    ...
    items: [
      ...
      {
        icon: "DollarSign",
        title: "The Revenue Leakage Problem",
        body: "Facilities that manage billing manually systematically leak revenue through missed charges (services delivered but not billed), unbundled charges, and delayed claims. Research suggests 7-11% of billable services in manual billing environments are never billed. For a facility generating $2M annually, 9% leakage represents $180,000 in recoverable revenue.",
      },
      {
        icon: "Shield",
        title: "The Compliance and Documentation Problem",
        body: "Healthcare is heavily regulated: HIPAA (USA), CQC standards (UK), DHA/HAAD (UAE), PMDC (Pakistan). Paper-based systems struggle to meet requirements: incomplete records, non-existent audit trails, difficult-to-enforce data security, and regulatory documentation taking weeks of manual assembly rather than minutes of automated reporting.",
      },
      {
        icon: "Calendar",
        title: "The Scheduling Inefficiency Problem",
        body: "Inefficiencies frustrate patients and reduce clinical utilisation: overbooking creating waiting room backlogs, underbooking leaving clinical time unused, inability to identify available slots across multiple clinicians, and no automated reminders producing no-show rates of 15-25% that waste clinical capacity daily.",
      },
    ],
    afterTitle: "Our ClickCare HMS",
    afterHighlight: "Solution",
    afterItems: [
      {
        icon: "Users",
        title: "Patient Registration and EMR",
        body: "Central patient master index ensuring unique identification across all interactions. Electronic Medical Records with SOAP note structure, clinical decision support alerts for drug interactions and allergies, and longitudinal patient timeline displaying complete medical history from a single screen.",
      },
      {
        icon: "Calendar",
        title: "Appointment and Scheduling Management",
        body: "Multi-resource scheduling across clinicians, consultation rooms, diagnostic equipment, and operating theatres. Online appointment booking portal for patients 24/7. Automated SMS and email reminders reducing no-shows by 40-60%.",
      },
      {
        icon: "Pill",
        title: "Pharmacy and Prescription Management",
        body: "E-prescribing with electronic transmission to pharmacy queue. Drug formulary and interaction checking against allergies and current medications. Pharmacy inventory management tracking stock levels, expiry dates, and batch numbers with automated reorder alerts.",
      },
    ],
  },
  features: [
    {
      ...
      title: "Patient Registration and EMR",
      intro: "Central patient record ensuring each patient is registered once and identified uniquely across all interactions.",
      blocks: [
        {
          h: "Patient Master Index and Registration",
          p: "Demographic data (name, DOB, contact, address, next of kin), insurance information (payer, policy number, pre-authorisation status), clinical identifiers (blood group, allergies, chronic conditions, current medications). Duplicate patient detection algorithm prevents multiple records for the same patient.",
        },
        {
          h: "Electronic Medical Records (EMR)",
          p: "SOAP note structure (Subjective, Objective, Assessment, Plan) with template-driven data entry. Clinical decision support alerts flagging drug-drug interactions, allergy conflicts, and contraindications. Longitudinal patient timeline displaying complete medical history in chronological order from a single screen.",
        },
      ],
    },
    {
      ...
      tag: "Scheduling",
      title: "Appointment and Scheduling Management",
      intro: "Managing appointments across all the resources that healthcare scheduling requires.",
      blocks: [
        {
        ...
        },
        {
          ...
          p: "Patient-facing web and mobile portal allowing patients to book, reschedule, and cancel appointments without staff involvement, 24/7. Reduces telephone workload, improves patient convenience, generates digital appointment data for automated reminders.",
        },
        {
          h: "Appointment Reminders and No-Show Reduction",
          p: "Automated SMS, email, or WhatsApp reminders at configurable intervals (typically 48 hours and 2 hours). Reduces no-show rates by 40-60%. Includes cancellation or rescheduling link so slots can be reallocated.",
        },
      ],
    },
    {
      ...
      tag: "Pharmacy",
      title: "Pharmacy and Prescription Management",
      intro: "Connecting clinical consultation to dispensing counter with electronic prescription management.",
      blocks: [
        {
          h: "E-Prescribing and Pharmacy Dispensing",
          p: "Prescriptions generated in EMR transmitted electronically to pharmacy queue. Dispensing pharmacist reviews and dispenses from pharmacy inventory. Eliminates illegible handwriting errors, ensures availability before patient arrival, maintains prescription audit trail for controlled substance regulations.",
        },
        {
          h: "Drug Formulary and Interaction Checking",
          p: "Maintains facility's drug formulary with standard dosing guidance, cost information, generic substitution rules. Clinical decision support checks prescribed medication against documented allergies, current medications (drug-drug interaction), and clinical contraindications.",
        },
        {
    ...
    },
    {
      ...
      intro: "Managing the complete investigation cycle from ordering to result delivery.",
      blocks: [
        {
          h: "Investigation Ordering and Results",
          p: "Clinician orders investigations directly from patient encounter in EMR. Laboratory receives and processes requests. Results entered or received electronically from connected analysers. Delivered back to clinician with normal range indicators and critical value alerts for timely clinical response.",
        },
        {
    ...
    },
    {
      ...
      intro: "Automatic charge capture from clinical records eliminating revenue leakage.",
      blocks: [
        {
        ...
        },
        {
          ...
          p: "Eligibility verification before encounter, claims generation in appropriate electronic format (HCFA 1500, UB-04, or insurer-specific formats), claims submission tracking, denial management workflow analysing denial reasons and managing resubmission process.",
        },
        {
          h: "Patient Billing and Payment Collection",
          p: "Generates patient statement with itemised charges, produces receipt at point of payment, manages outstanding balance tracking and payment reminder sequence. Payment methods: cash, card via integrated terminal, instalment plan management for high-value treatments.",
        },
      ],
    },
    {
      ...
      intro: "Structured reports for clinical governance and operational management with regulatory compliance tools.",
      blocks: [
        {
          h: "Clinical and Operational Reporting",
          p: "Patient census and bed occupancy (inpatient), outpatient attendance and appointment utilisation (booked vs attended vs DNA by clinician and specialty), investigation turnaround time, diagnosis frequency analysis supporting clinical audit, clinical outcome tracking for quality improvement.",
        },
        {
          h: "HIPAA and Regulatory Compliance Tools",
          p: "Role-based access control (each user's access limited to records and functions their role requires), access audit log (every record access logged with user identity, timestamp, action), data encryption at rest (AES-256) and in transit (TLS 1.3).",
        },
        {
          h: "Multi-Facility and Multi-Specialty Configuration",
          p: "Manage all facilities from single ClickCare instance, cross-facility patient record access supporting referrals and transfers, facility-level and group-level reporting, specialty-specific configuration (consultation templates, investigation panels, pricing schedules).",
        },
      ],
    },
  ],
  ...
  why: [
    {
      icon: "Globe",
      h: "Multi-jurisdiction compliance",
      p: "ClickCare HMS is designed for its healthcare markets: HIPAA compliance for USA, CQC documentation standards for UK, DHA/HAAD electronic health record standards for UAE, and PMDC standards for Pakistan. Compliance is a first-class design requirement in every feature.",
    },
    {
      icon: "ClipboardList",
      h: "Clinical workflow preservation",
      p: "Healthcare software that forces radical workflow changes encounters resistance undermining the commercial case. ClickCare digitises existing clinical workflows: consultation documentation mirrors existing note structure, investigation ordering reflects current request processes, and configuration tools map ClickCare to each facility's specific protocols.",
    },
    {
      icon: "Wifi",
  ...
  faqs: [
    ...
    },
    {
      ...
      a: "Patient data security is a first-class design requirement: all data encrypted at rest (AES-256) and in transit (TLS 1.3), access controlled by role-based permissions limiting each user's access to records and functions their role requires, every record access logged in immutable audit trail (user, timestamp, action, record accessed), and system architecture prevents any patient data from being stored on client devices (all data resides in ClickCare's cloud infrastructure). For US healthcare facilities, ClickCare HMS includes the Business Associate Agreement (BAA) that HIPAA requires for cloud-hosted health record systems.",
    },
    {
    ...
    },
    {
      ...
      a: "ClickCare HMS currently supports healthcare operations in the USA (HIPAA compliance, CPT/ICD-10 coding, CMS claim formats), the UK (CQC documentation standards, NHS data standards where applicable, GDPR compliance), the UAE (DHA and HAAD electronic health record standards, DHPO claim submission, national health insurance formats), and Pakistan (PMDC standards, Sehat Sahulat Programme integration where applicable, and standard billing formats for major Pakistani health insurance providers). Implementation teams with jurisdiction-specific expertise manage deployments in each market.",
    },
    {
    ...
    },
    {
      ...
      a: "Implementation includes structured training for each user group: administrator training (system configuration, user management, reporting), reception and scheduling training (patient registration, appointment management, billing intake), clinical staff training (EMR documentation, electronic prescribing, investigation ordering), pharmacy training (dispensing workflow, inventory management), and finance staff training (billing, claims management, payment collection). Training delivered in person at the facility (for UAE and Pakistan) or via video conference (for UK and USA). Post-go-live, we provide a 60-day hypercare support period with priority response times.",
    },
    {
