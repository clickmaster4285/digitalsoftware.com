export const InfographicDesignContent = {
  slug: "infographic-design-services",
  metadata: {
    url: "/infographic-design-services/",
    keyword: "infographic design services",
    volume: "2,400/mo",
    cpc: "N/A",
    formula: "PAS",
    author: "Amjad Khan",
  ...
  hero: {
    ...
    stats: [
      ...
      { k: "180%", v: "Organic traffic growth" },
  ...
  intro: {
    problem: [
      ...
      { text: "earn backlinks", type: "highlight" },
  ...
  problem: {
    ...
    titleHighlight: "Most Business Infographics",
    items: [
      {
        icon: "Paintbrush",
        title: "The Ugly Truth About Most Infographics",
        body: "Most infographics fail on three dimensions: design quality (amateurish visuals signal amateurish expertise), information architecture (visually cluttered, difficult to read quickly), and strategic purpose (existing because someone said 'do an infographic' without defining audience, distribution, or action). An infographic failing any dimension produces no marketing value.",
      },
      {
        icon: "TrendingUp",
  ...
  services: [
      ...
      blocks: [
        {
          ...
          p: "Original research publications (turning surveys into shareable assets), industry benchmark presentations, competitive comparison data (comparing options across multiple dimensions), geographic data (maps showing regional variation), and time-series data (trend lines showing metric evolution).",
        },
        {
    ...
    },
    {
      ...
      icon: "GitBranch",
      tag: "Process",
      title: "Process and How-To Infographics",
      intro:
        "Translating multi-step workflows, procedures, and how-to guides into visual formats that communicate sequences clearly and compactly.",
      blocks: [
        {
          h: "Step-by-Step Process Visualisation",
          p: "Onboarding guides (new customer, employee, product setup), compliance and regulatory process explanations, product workflow diagrams (how our process works), decision trees (if A then B visual guides), and technical how-to content (implementing or configuring tools or systems).",
        },
        {
          h: "Comparison and Versus Infographics",
          p: "Product category comparisons (Product A vs Product B across dimensions), technology comparison (which tool for which use case), before-and-after comparisons (problem state to solution state), and strategic option comparisons (pros, cons, and right fit for each).",
        },
      ],
    },
    {
      ...
      blocks: [
        {
          h: "Timeline Design",
          p: "Company history and milestone presentations (corporate anniversary content, investor pitch decks), product development roadmaps (what's built, what's coming, when), industry history pieces (evolution of technology or market over time), and case study progressions (problem to solution to outcome month by month).",
        },
        {
      ...
      blocks: [
        {
          ...
          p: "Large data sets requiring filtering (interactive maps with regional data, interactive timelines with clickable detail), personalised calculators and assessment tools (what would this cost me, how does my score compare), and multi-dimensional comparisons (select criteria and see which option scores highest). Built with D3.js, Chart.js, and custom JavaScript.",
        },
        {
      ...
      blocks: [
        {
          ...
          p: "Visual system (colour palette, typography, icon style, chart styling, layout grids) making every output recognisable as the brand's content. Template files in Adobe Illustrator, Figma, or PowerPoint formats enabling content teams to produce branded infographics without requiring a designer for every piece.",
        },
        {
      ...
      blocks: [
        {
          ...
          p: "Identifying publications most likely to embed the infographic, developing outreach pitch presenting the infographic as a resource their readers would value, managing outreach sequence, and tracking embed placements and backlinks earned. Targeting industry publications, trade media, general interest publications, educational websites, and journalists.",
        },
        {
  ...
  cases: [
    {
      tag: "B2B Technology · Infographic Outreach",
      metric: "64",
    ...
    },
    {
      ...
      metric: "180%",
      sub: "organic traffic increase · 4,200 social shares",
      title: "Infographic series drives 180% increase in organic traffic.",
      body: "Healthcare information publisher produced 12 monthly infographics covering health statistics for healthcare professionals and informed consumers. Each combined authoritative public health data (WHO, CDC, NHS) with compelling visual presentation. Program: monthly data research, branded design execution, social optimisation (full-size, square, vertical crops), bi-monthly outreach to health media. Result: organic traffic +180% over 12 months as series pages accumulated backlinks and Google Image Search visibility. 4,200 combined social shares. Three infographics earned 20+ editorial backlinks each, driving significant health statistics keyword ranking improvements.",
    },
    {
      tag: "Professional Services · Sales Enablement",
      metric: "30%",
  ...
  faqs: [
    ...
    },
    {
      ...
      p: true,
      a: "Standard deliverables: PNG (screen-optimised, for web and social), SVG (vector format, no quality loss at any size), PDF (print-ready), and social media variants (cropped for Instagram square, Instagram Stories, LinkedIn, Twitter/X). For interactive infographics: complete HTML/CSS/JavaScript package. For template systems: design files in client's tool (Adobe Illustrator, Figma, or PowerPoint/Google Slides).",
    },
    {
    ...
    },
    {
      ...
      a: "Standard engagement includes two rounds of structured revisions: one after initial design concept presentation (layout, visual approach, data presentation choices), and one after first full design version (copy edits, colour, refinements). Additional revision rounds available at fixed rate if scope changes significantly or stakeholder feedback introduces new requirements. We mitigate scope expansion through a thorough pre-design content architecture approval step.",
    },
    {
