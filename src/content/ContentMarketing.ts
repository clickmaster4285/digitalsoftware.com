export const ContentMarketingContent = {
  ...
  hero: {
    ...
    stats: [
      ...
      { k: "38%", v: "Revenue from organic" },
      { k: "24+", v: "Months of compounding" },
    ],
  },
  intro: {
    problem: [
  ...
  problem: {
    ...
    titleHighlight: "From Content That Doesn't",
    items: [
      {
        icon: "TrendingUp",
      ...
      },
      {
        icon: "Award",
        title: "What Separates Content That Ranks",
        body: "Google's algorithm distinguishes between content created to rank and content created to genuinely serve users. Content that ranks demonstrates first-hand experience, provides information not available elsewhere, earns deep audience engagement, and attracts links from other authoritative websites as a trusted source.",
      },
      {
        icon: "Map",
    ...
    afterItems: [
      {
        icon: "Search",
        title: "Topic Authority Mapping",
        body: "Google rewards sites that demonstrate comprehensive expertise in a specific topic area. Topical authority is built by creating a comprehensive cluster of content: a pillar page covering the core topic, supported by cluster articles covering specific subtopics in depth.",
      },
      {
        icon: "Users",
        title: "Audience and Intent Mapping",
        body: "We map content to the full funnel: top-of-funnel awareness content (educational), middle-of-funnel consideration content (comparative, evaluative), and bottom-of-funnel conversion content (solution-specific, ROI-focused). Each piece has a clearly defined funnel position.",
      },
      {
        icon: "Calendar",
  ...
  services: [
      ...
      blocks: [
        {
          ...
          p: "We identify every keyword cluster your audience searches that you are not ranking for, with commercially meaningful search intent, producing a prioritized content opportunity list for your website and competitive landscape.",
        },
        {
          h: "Topical Authority Mapping & Intent Mapping",
          p: "We develop pillar-to-cluster content architectures that build domain authority. We map content to top-of-funnel (awareness), middle-of-funnel (consideration), and bottom-of-funnel (conversion) stages.",
        },
      ],
    },
    {
      ...
      blocks: [
        {
          ...
          p: "Each piece is structured for Google's algorithm (semantic keyword integration, proper heading hierarchy, internal links, E-E-A-T signals) and for human readers (scannable format, clear headings, relevant examples, actionable takeaways).",
        },
        {
    ...
    },
    {
      ...
      intro:
        "Pillar pages (3,000-8,000 words) cover core topics as definitive resources, supported by cluster content (1,000-2,500 words) covering specific subtopics in depth.",
      blocks: [
        {
          h: "Pillar Page Development",
          p: "We develop pillar pages that define and explain core topics comprehensively, cover all major subtopics, provide original data or frameworks, include multimedia elements, and link to the full cluster of supporting content.",
        },
        {
      ...
      blocks: [
        {
          ...
          p: "We develop case studies through a structured process: client briefing for specific metrics, subject matter interviews for technical depth, drafting with proven narrative structure (problem → challenge → approach → results → takeaways), and SEO optimization for service/industry keyword clusters.",
        },
        {
          h: "Dual Purpose Content",
          p: "Our case studies serve as trust-building content for prospective customers in consideration and decision stages, and as SEO content targeting commercial-intent keywords related to the service and industry served.",
        },
      ],
    },
    {
      ...
      blocks: [
        {
          h: "Lead Magnet Types",
          p: "Research reports (original surveys, data analysis) produce highest conversion rates. Definitive guides serve as professional reference tools. Templates and tools provide immediate practical value. Webinars produce higher-quality leads through stronger qualification signals.",
        },
        {
          h: "Landing Page and Conversion Optimization",
          p: "We develop landing pages and conversion pathways including page copy, form design, thank-you pages, and initial lead nurture email sequences that activate immediately after form submission.",
        },
      ],
    },
    {
      ...
      intro:
        "Great content with no distribution strategy reaches no one. We amplify content through organic search, social media, email newsletters, and targeted link building.",
      blocks: [
        {
          h: "Search & Social Distribution",
          p: "Every piece is optimized for organic search from first draft. Social media distribution plans identify platforms and formats most likely to drive distribution for each content type, audience, and topic.",
        },
        {
          h: "Email & Link Building",
          p: "New content is featured in email newsletters for existing subscribers. High-value content assets are promoted through targeted outreach to relevant publications and industry blogs for editorial citation links.",
        },
      ],
    },
  ],
  cases: [
    {
      tag: "B2B SaaS · Project Management",
      metric: "14x",
      sub: "traffic growth · 3,200 → 47,800 visitors",
      title: "B2B SaaS company achieves 14x organic traffic growth and 2,400 monthly leads in 18 months.",
      body: "A project management software company had 3,200 monthly organic visitors (mostly branded). Our 18-month program: 840 keyword opportunities identified, 6 pillar pages, 72 cluster articles, 8 research reports as lead magnets, quarterly content refreshes. Result: Monthly organic visitors grew to 47,800 (14x increase), leads grew from 180 to 2,400 per month, domain authority increased from 48 to 67.",
    },
    {
      tag: "Professional Services · Consulting",
      metric: "$680K",
    ...
    },
    {
      ...
      metric: "38%",
      sub: "revenue from organic · 2,100 → 34,600 visitors",
      title: "E-commerce lifestyle brand content drives 38% of total revenue from organic.",
      body: "A home wellness e-commerce brand had DR 41 with only product pages and a neglected blog. Our 24-month program: category-level buying guides for commercial keywords, product comparison articles for consideration-stage queries, wellness education blog for top-of-funnel queries. Result: Organic became the largest revenue channel at 38%, monthly visitors grew from 2,100 to 34,600, content-attributed revenue reached $280,000/month, marketing cost as % of revenue decreased from 34% to 21%.",
    },
  ],
  why: [
    {
  ...
  faqs: [
    {
      ...
      a: "Content marketing is a compounding channel. Timeline: months 1-3 see initial indexing for lower-competition keywords; months 4-6 see meaningful search traffic growth; months 6-12 see significant traffic increases as pillar pages and clusters reach competitive rankings; months 12-24 see full compounding effect. We recommend evaluating on a 12-month minimum horizon.",
    },
    {
      q: "How much content do we need to publish to see results?",
      a: "For moderately competitive topics on a mid-authority domain, 4-8 substantive pieces per month typically produces meaningful growth within 6-9 months. For highly competitive topics, higher frequency is required. For low-competition niches or local businesses, 2-4 pieces per month can build visibility within 4-6 months.",
    },
    {
    ...
    },
    {
      ...
      a: "Content marketing and SEO are deeply integrated. Content marketing without SEO produces content nobody finds through search. SEO without content marketing has nothing to rank. Content marketing refers to strategy and production of valuable content assets; SEO refers to technical and off-page optimization that helps content rank. Our service integrates both from keyword research through final optimization.",
    },
    {
      q: "How do you measure content marketing ROI?",
      a: "We measure through layered attribution: organic traffic attributed to content (GA4 + Search Console), form submissions and leads attributed to organic content, pipeline and revenue through CRM integration, and content-specific metrics (page views, time on page, scroll depth, backlinks earned). We also track cost-per-organic-lead against cost-per-lead from paid channels.",
    },
    {
    ...
    },
    {
      ...
      a: "Book a free content audit. We review your existing content, analyze your search traffic and keyword rankings, identify your top three to five content gaps and opportunities, and provide a preliminary content strategy recommendation. No commitment required at the audit stage.",
    },
  ],
  cta: {
