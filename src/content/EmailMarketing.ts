export const EmailMarketingServicesContent = {
  ...
  hero: {
    ...
    stats: [
      ...
      { k: "200%", v: "Trial conversion improvement" },
      { k: "72%", v: "No-show reduction" },
    ],
  },
  intro: {
    problem: [
  ...
  problem: {
    ...
    titleHighlight: "Most Email Marketing Programs",
    items: [
      {
        icon: "TrendingDown",
    ...
    afterHighlight: "That Generate Revenue",
    afterItems: [
      {
        icon: "ClipboardCheck",
  ...
  services: [
    {
      ...
      tag: "Audit & Strategy",
      title: "Email Program Audit and Strategy",
      intro: "Before building anything new, we audit what exists and create a prioritized build plan ordered by revenue impact.",
      blocks: [
        {
    ...
    },
    {
      ...
      tag: "Deliverability",
      title: "Deliverability Foundation",
      intro: "Email deliverability is the foundation of the entire programme. An email sequence that goes to spam generates zero revenue regardless of how well it is written.",
      blocks: [
        {
          h: "Email Authentication Setup",
          p: "SPF, DKIM, and DMARC are the three technical authentication standards that receiving mail servers use to verify that your emails are actually coming from you. A DMARC policy set to enforcement mode and correctly configured SPF and DKIM records are the foundation of inbox placement.",
        },
        {
          h: "List Hygiene and Engagement Management",
          p: "Systematic list hygiene: removing hard bounces immediately, managing soft bounce patterns, identifying chronically unengaged subscribers and running re-engagement campaigns before removing them, and verifying new subscriber emails through validation tools.",
        },
        {
          h: "Sender Reputation Monitoring",
          p: "Continuous monitoring of spam complaint rates (via Google Postmaster Tools and Microsoft SNDS), bounce rates by ISP, inbox placement rates, and engagement rate trends that indicate list health deterioration before it becomes a deliverability crisis.",
        },
      ],
    },
    {
      ...
      blocks: [
        {
          h: "Welcome Sequence",
          p: "The most important automation. Open rates on welcome emails average 50-80%, compared to 20-25% for broadcast campaigns. A 5-7 email sequence over 10-14 days introduces the brand, delivers on the opt-in promise, builds the relationship, and transitions toward a commercial relationship with a carefully timed offer.",
        },
        {
          h: "Abandoned Cart Sequence (E-Commerce)",
          p: "A properly structured 3-email abandoned cart sequence can recover 10-15% of the 70% average abandonment rate: Email 1 sent 1-4 hours after abandonment (highest recovery rate), Email 2 at 24 hours with social proof, Email 3 at 48-72 hours with an optional friction-reducing offer.",
        },
        {
          h: "Browse Abandonment, Post-Purchase, and Win-Back",
          p: "Browse abandonment emails re-engage consideration-stage shoppers. Post-purchase sequences build lifetime value through order confirmation, pre-delivery content, review requests, and cross-sells. Win-back sequences recover lapsed customers at significantly lower cost than acquiring new equivalents.",
        },
        {
    ...
    },
    {
      ...
      intro: "Strategic broadcast campaigns maintain subscriber engagement and generate immediate revenue from promotional offers.",
      blocks: [
        {
          h: "Campaign Strategy and Calendar",
          p: "Monthly campaign calendars balancing: promotional campaigns (direct revenue generation), relationship campaigns (value-delivery emails without an immediate commercial ask), and content campaigns (blog content, video, research, and insights positioning the brand as a trusted information source).",
        },
        {
          h: "List Segmentation for Relevance at Scale",
          p: "Sending the same email to every subscriber is the single most common and most costly email marketing mistake. We implement segmentation by demographics, behaviour (purchase history, browse history, email engagement), lifecycle stage (new subscriber, first-time buyer, repeat customer, VIP, lapsed), and preferences.",
        },
        {
          h: "Subject Line Strategy and A/B Testing",
          p: "Subject line quality is the largest variable in open rate. We develop strategies testing direct vs. curiosity-driven approaches, personalisation token usage, emoji use, and length. We A/B test subject lines for all campaigns with sufficient volume for statistical significance.",
        },
      ],
    },
    {
      ...
      icon: "UserPlus",
      tag: "List Growth",
      title: "List Growth and Lead Capture",
      intro: "The most effective email list growth combines a compelling reason to subscribe with high-visibility opt-in placement.",
      blocks: [
        {
          h: "Opt-In Strategy and Lead Magnet Development",
          p: "We develop lead magnet strategies: identifying specific offers most likely to attract high-quality subscribers, developing the lead magnet content, and implementing opt-in placement and form design that maximizes conversion rate from website visitors to email subscribers.",
        },
        {
          h: "Pop-Up and Form Optimization",
          p: "Pop-ups, when implemented correctly, consistently convert 3-8% of website visitors into email subscribers. We design and A/B test timing (exit-intent vs. time-delay vs. scroll-depth), offer framing, form design, and mobile optimization. For e-commerce: spin-to-win, first-order discounts. For B2B: research reports and industry studies.",
        },
      ],
    },
    {
