export const LocalSeoContent = {
  ...
  hero: {
    ...
    stats: [
      ...
      { k: "70+", v: "Directory citations" },
      { k: "10+ yrs", v: "Local SEO expertise" },
    ],
  },
  intro: {
    problem: [
    ...
    afterItems: [
      {
        icon: "Target",
        title: "Relevance",
        body: "How closely does the business match what the user searched for? Determined by the content and completeness of your Google Business Profile, keywords on your website's service and location pages, and topical alignment across your digital presence.",
      },
      {
        icon: "Navigation",
        title: "Distance",
        body: "How close is the business to the searcher or specified location? Optimized by ensuring your GBP service area is correctly configured and creating location-specific content targeting searches from specific neighborhoods, suburbs, and surrounding areas.",
      },
      {
        icon: "Star",
        title: "Prominence",
        body: "How well-known and respected is the business? Determined by the volume and quality of online reviews, number and quality of backlinks, volume and consistency of local citations, domain authority, and GBP engagement.",
      },
    ],
  },
  services: [
    {
      ...
      intro: "Your Google Business Profile (GBP) is the single most important asset in your local SEO presence. It appears in the maps pack, displays your reviews, shows your hours, and is what Google's AI uses to evaluate your business.",
      blocks: [
        {
          h: "Primary and Secondary Category Selection",
          p: "We conduct thorough category research, selecting the most precise primary category and all eligible secondaries to maximize search query coverage. Most businesses select one or two obvious categories and miss dozens of relevant secondaries.",
        },
        {
          h: "Complete Profile Build-Out",
          p: "Business description with strategic keyword integration, full service and product listings with individual descriptions, all relevant attributes, Q&A pre-populated with common customer questions, appointment links, and verified contact details.",
        },
        {
          h: "GBP Photo and Video Strategy",
          p: "Profiles with photos receive significantly more direction requests, calls, and website clicks. We develop a photo strategy covering interior, exterior, team, products, services, logo, and cover images with a systematic addition schedule.",
        },
        {
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          p: "For businesses with a rating below 4.0, we implement reputation repair campaigns: structured review generation to dilute negative reviews with authentic positive ones, combined with direct outreach to negative reviewers where appropriate.",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      intro: "The off-page SEO signals most relevant to local rankings differ from national rankings. Local link building targets the specific sources Google uses to assess prominence within your geographic community.",
      blocks: [
        {
          h: "Local Business Directory and Association Links",
          p: "Membership in local business associations, chambers of commerce, and industry-specific local organizations produces high-value local links Google specifically weights in local prominence calculation.",
        },
        {
          h: "Local Media and PR Coverage",
          p: "Coverage in local newspapers, city-specific online publications, neighborhood blogs, and local radio websites produces the highest-value local authority signals. We develop local PR campaigns generating genuine local media coverage.",
        },
        {
  ...
  cases: [
    {
      tag: "Dental · Multi-Location",
      metric: "312%",
      sub: "increase in online appointments",
      title: "Dental practice group sees 312% increase in online appointment bookings.",
      body: "Five-location Houston dental group with inconsistent GBP optimization, 23-45 reviews per location at 4.0-4.2 stars, no localized content. Our 12-month program: complete GBP optimization, review generation system producing 80-140 new reviews per location, citation corrections across 65 directories, five new localized service pages per location, LocalBusiness schema. Result: All five locations achieved local pack placement. Average reviews grew to 165 at 4.8 stars. Online appointment inquiries increased 312%.",
    },
    {
      tag: "HVAC · Zero to Market Leader",
      metric: "47",
    ...
    },
    {
      ...
      metric: "280%",
      sub: "increase in multi-state leads",
      title: "Law firm achieves multi-city expansion using local SEO landing pages.",
      body: "NY personal injury law firm wanted leads in New Jersey, Connecticut, and Pennsylvania without opening physical offices. Our strategy: state-specific practice area pages with local legal context, optimized GBP profiles with service area configurations, local citations in each market. Result: First-page rankings for primary keywords in all four markets within 10 months. Multi-state leads increased 280%. Digital channel revenue grew $2.1M in 18 months.",
    },
  ],
  why: [
    {
  ...
  faqs: [
    {
      ...
      a: "For businesses with an established GBP and existing reviews, measurable local pack ranking improvements typically become visible within 6 to 12 weeks. For businesses starting from scratch, the timeline is typically 3 to 6 months for less competitive markets and 6 to 12 months for highly competitive ones. The timeline depends on market competitiveness, current local presence state, and consistency of implementation.",
    },
    {
