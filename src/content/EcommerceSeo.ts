export const EcommerceSeoContent = {
  ...
  hero: {
    ...
    stats: [
      ...
      { k: "156%", v: "Traffic increase (technical sprint)" },
      { k: "10+ yrs", v: "E-commerce SEO depth" },
    ],
  },
  intro: {
    problem: [
  ...
  problem: {
    ...
    items: [
      {
        icon: "Boxes",
        title: "Scale and Duplication Challenges",
        body: "A mid-size e-commerce store with 5,000 products generates content and URL complexity that a 50-page service website does not. Faceted navigation generates thousands of unique URL combinations. Product variants create near-duplicate pages. Manufacturer descriptions create cross-domain duplicate content. Managing these requires e-commerce-specific SEO expertise.",
      },
      {
        icon: "Target",
        title: "Purchase Intent Keyword Architecture",
        body: "Category-level keywords ('women's running shoes'), product-level keywords ('Nike Air Zoom Pegasus 41 women'), comparison keywords, and transactional long-tail keywords each require different page types, content strategies, and conversion architectures.",
      },
      {
        icon: "DollarSign",
      ...
      {
        icon: "Cpu",
        title: "Platform-Specific Technical Constraints",
        body: "Shopify, WooCommerce, Magento, and BigCommerce each have platform-specific technical SEO constraints, default behaviors that suppress rankings, and optimization approaches requiring platform-specific knowledge. Addressing these requires engineers who know these platforms deeply.",
      },
    ],
  },
  services: [
    {
      ...
      blocks: [
        {
          h: "Crawl Budget Management and Faceted Navigation",
          p: "For stores with thousands of products, Google's crawl budget is finite. Faceted navigation can generate millions of URL combinations. We implement crawl budget strategies: robots.txt blocking faceted navigation, canonical tags on filtered pages, JavaScript-based URL modifications that don't create new indexable URLs.",
        },
        {
          h: "Product Variant and Duplicate Content Management",
          p: "Product variants create near-duplicate content at scale. We design variant page strategies that provide genuine SEO value for high-traffic variant combinations while preventing thin duplicate pages from polluting the index.",
        },
        {
          h: "Site Architecture for Large Catalogs",
          p: "Every product needs to be reachable within 3 clicks from the homepage to receive adequate crawl priority. For stores with deep category hierarchies, we redesign navigation and internal linking to bring high-value products closer to the surface.",
        },
      ],
    },
    {
      ...
      blocks: [
        {
          ...
          p: "Identifying primary keywords (highest volume, highest purchase intent), secondary keywords for supporting content, and long-tail variants to capture through product listing filters and subcategory pages.",
        },
        {
          h: "Category Page Content Development",
          p: "300-600 words of above and below-the-fold copy providing Google with topical context, communicating genuine value to consumers, and including buying guides or feature comparisons. Adding well-structured content to text-free category pages consistently produces measurable ranking improvements within 60-90 days.",
        },
        {
          h: "Category Page Internal Linking and Breadcrumbs",
          p: "Comprehensive breadcrumb navigation as both user experience and structured data signal, plus internal linking architectures connecting related categories to distribute authority efficiently.",
        },
      ],
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          p: "Manufacturer-provided descriptions create cross-domain duplicate content. We develop original, unique product descriptions written from a buyer's perspective with benefit-led copy and specific details purchase-intent searchers look for.",
        },
        {
    ...
    },
    {
      ...
      icon: "ShoppingCart",
      tag: "Platform",
      title: "Platform-Specific E-Commerce SEO",
      intro:
        "Platform matters because default behaviors, URL structures, and technical limitations directly determine what SEO optimizations are possible.",
      blocks: [
        {
          h: "Shopify SEO",
          p: "Shopify's URL structure creates canonical tag complications when products appear in multiple collections. Default theme files often include render-blocking resources damaging Core Web Vitals. We address all platform-specific issues alongside standard optimizations.",
        },
        {
          h: "WooCommerce SEO",
          p: "Default installations generate product tag pages, attribute pages, and variation pages creating index pollution. We configure SEO settings, manage product variation indexation, and optimize the database for crawl performance.",
        },
        {
          h: "Magento SEO",
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          p: "Product reviews on relevant blogs and influencer platforms produce high-converting traffic and links with strong topical relevance. We identify and outreach to bloggers and micro-influencers for genuine review coverage.",
        },
        {
          h: "Brand Mention Conversion",
          p: "Unlinked brand mentions in press coverage and social posts represent significant link building opportunities. We identify unlinked mentions and convert them to followed backlinks through direct outreach.",
        },
      ],
    },
  ],
  cases: [
    {
      tag: "Premium Kitchen Equipment · Category SEO",
      metric: "89%",
  ...
  why: [
    ...
    {
      icon: "DollarSign",
      h: "Revenue-first measurement",
      p: "We measure e-commerce SEO success in revenue, not traffic. Every monthly report connects organic rankings and traffic to actual purchase data from your GA4 e-commerce tracking. You always know what your SEO investment is returning in revenue.",
    },
    {
      icon: "Layers",
  ...
  faqs: [
    ...
    },
    {
      ...
      a: "They serve different functions and are most powerful together. Paid ads deliver immediate traffic and revenue but require continuous investment. SEO takes longer to build but produces traffic that doesn't stop when you stop paying. For most e-commerce businesses, the optimal approach is using paid ads to maintain visibility while building organic authority for long-term, cost-efficient revenue growth. As organic channels grow, total revenue increases while cost-per-acquisition decreases.",
    },
    {
    ...
    },
    {
      ...
      a: "We support all major e-commerce platforms: Shopify, WooCommerce, Magento 2, BigCommerce, Wix eCommerce, Squarespace Commerce, and custom-built stores. For enterprise platforms including Salesforce Commerce Cloud, SAP Commerce, and Adobe Commerce, we work in collaboration with your internal development team.",
    },
    {
    ...
    },
    {
      ...
      a: "Book a free e-commerce SEO audit. We'll review your store's current technical health, identify your three highest-opportunity category pages, check your Product schema implementation, and give you a clear picture of the specific organic revenue opportunity your store is currently leaving on the table. No commitment required.",
    },
  ],
  cta: {
