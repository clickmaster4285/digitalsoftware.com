export const AiMarketingServicesContent = {
  slug: "ai-marketing-services",
  metadata: {
    url: "/ai-marketing-services/",
    keyword: "ai marketing services",
    volume: "9,900/mo",
    cpc: "$31.40",
    formula: "AIDA",
    author: "Amjad Khan",
  ...
  services: [
    ...
    },
    {
      ...
      icon: "Target",
      tag: "Lead Scoring",
      title: "Predictive Lead Scoring and Pipeline Intelligence",
      intro: "",
      blocks: [
        {
          h: "AI LEAD SCORING MODELS",
          p: "Traditional lead scoring is rules-based: assign points for job title, company size, content downloads, email opens, and web pages visited according to a manually configured scoring formula. AI lead scoring replaces the manual formula with a model trained on the historical relationship between lead behaviour and lead outcome — identifying the specific combinations of signals that actually predict conversion, weighted by their actual predictive value rather than by a marketer's assumption about their importance.\n\nWe develop and deploy AI lead scoring models: training on the historical CRM data (lead behaviour, lead attributes, and final outcome for each lead), building models that predict conversion probability for each new lead as it enters the funnel, integrating the scores into the CRM (Salesforce, HubSpot) so the sales team works the highest-probability leads first, and monitoring model performance over time to retrain as market conditions and buyer behaviour evolve.",
        },
        {
          h: "MARKETING ATTRIBUTION MODELLING",
          p: "Single-touch attribution (first-click or last-click) misattributes revenue to a single campaign touchpoint, producing marketing investment decisions that over-invest in the channels that happen to be first or last in the conversion path and under-invest in the channels that build the awareness and intent that make conversion possible. AI-powered multi-touch attribution models the actual contribution of each channel and campaign touchpoint to each conversion — enabling marketing investment allocation based on measured incremental contribution rather than positional attribution.",
        },
      ],
    },
    {
      ...
      icon: "User",
      tag: "Personalisation",
      title: "AI-Powered Personalisation and Recommendation",
      intro: "",
      blocks: [
        {
          h: "WEBSITE PERSONALISATION",
          p: "AI website personalisation serves different content, offers, and CTAs to different visitors based on their behaviour patterns, traffic source, device type, geographic location, and — for return visitors — their historical interaction data. A first-time visitor from a paid search ad for a specific product sees a landing page optimised for that product intent. A return visitor who previously viewed the pricing page but did not convert sees a personalised message addressing the specific objection that the pricing page visit suggests. A visitor from an enterprise company size segment sees the enterprise-specific social proof and case studies most likely to convert their specific decision context.\n\nWe implement website personalisation using dynamic content platforms (Optimizely, VWO, or custom personalisation layers), connecting visitor segment definitions to content variants through the rules engine that serves the appropriate experience to each visitor.",
        },
        {
          h: "EMAIL PERSONALISATION AND PREDICTIVE SEND-TIME OPTIMISATION",
          p: "AI email marketing goes beyond merge tags and segmentation to individual-level optimisation: predictive content selection (choosing which products, articles, or offers each recipient is most likely to engage with based on their interaction history), predictive send-time optimisation (identifying the specific time of day and day of week that each individual subscriber is most likely to open email, based on their historical open pattern), and lifecycle stage personalisation (matching email content to each subscriber's current position in the customer lifecycle — new subscriber, active user, at-risk churner — with sequences designed for each stage's specific conversion objective).",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      icon: "RefreshCw",
      tag: "Lifecycle",
      title: "AI Customer Lifecycle Marketing",
      intro: "",
      blocks: [
        {
    ...
    },
    {
      ...
      icon: "BarChart3",
      tag: "Analytics",
      title: "AI Marketing Analytics and Reporting",
      intro: "",
      blocks: [
        {
          h: "MARKETING MIX MODELLING",
          p: "Marketing Mix Modelling (MMM) is the AI-powered attribution methodology that identifies the contribution of each marketing channel to business outcomes at the aggregate level — accounting for the interaction effects between channels, the baseline sales that would occur without any marketing, and the saturation curves that determine the diminishing returns at higher spend levels in each channel. MMM enables marketing budget allocation decisions based on measured incremental contribution and predicted response curves.\n\nWe implement MMM using Meridian (Google's open-source MMM framework), PyMC-Marketing, and custom Bayesian models calibrated to each client's specific channel mix and conversion data. MMM is appropriate for businesses with 12+ months of marketing spend and revenue data across multiple channels.",
        },
        {
          h: "AI-POWERED MARKETING DASHBOARDS",
          p: "We build AI-powered marketing dashboards: natural language query interfaces (enabling marketing managers to ask questions like \"what drove the conversion rate increase in June?\" without writing SQL), anomaly detection that surfaces the significant deviations from expected performance automatically (rather than requiring manual review to find them), and forecasting models that project expected performance for the current period based on leading indicators — enabling proactive adjustments before the period ends.",
        },
      ],
    },
  ],
