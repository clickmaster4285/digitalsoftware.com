export const GraphicDesignContent = {
  slug: "graphic-design",
  metadata: {
    url: "/web-design-development/graphic-design/",
  ...
  hero: {
    ...
    stats: [
      ...
      { k: "47%", v: "Sales velocity increase (case)" },
      { k: "10+ yrs", v: "Design depth" },
    ],
  },
  intro: {
    problem: [
      { text: "Inconsistent design sends a specific message: this organisation is ", type: "normal" },
      { text: "not operating at the level of coherence it claims", type: "highlight" },
      { text: ". A company that produces excellent work but presents it through inconsistent, low-quality design is systematically communicating that it is a ", type: "normal" },
      { text: "smaller, less capable, less trustworthy organisation", type: "highlight" },
      { text: " than it actually is. The design gap between perception and reality is always paid in the currency of lost business.", type: "normal" }
    ],
    solution: [
  ...
  problem: {
    title: "What Inconsistent Design",
    ...
    items: [
      ...
      {
        icon: "PenTool",
        title: "The DIY Design Trap",
        body: "Many businesses use internal teams with tools like Canva or PowerPoint. Results are visually functional but professionally limited, inconsistent at scale, and increasingly expensive to maintain. The transition to professional design systems multiplies the perceived quality of every piece of marketing simultaneously.",
      },
      {
        icon: "BarChart3",
  ...
  services: [
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          p: "Logo usage rules (minimum sizes, clear space, approved/prohibited uses), colour specifications (hex, RGB, CMYK, Pantone), typography specifications (primary/secondary typefaces, usage rules), photography guidelines, and application examples across primary brand touchpoints.",
        },
      ],
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          p: "Every piece of collateral reinforces the same visual language rather than introducing new interpretations that fragment brand consistency. Where the brief requires elements not covered by existing guidelines, we develop extensions systematically and document them.",
        },
      ],
    },
    {
      ...
      blocks: [
        {
          ...
          p: "Post templates for each content type (promotional, educational, testimonial, product, announcement), Story and Reel cover frame templates, highlight cover design, and platform-specific format adaptations for Instagram, LinkedIn, Facebook, Twitter/X, and TikTok.",
        },
        {
          h: "Digital Advertising Creative",
          p: "Display banner sets (IAB standard sizes for GDN), social media ad creative (static images, carousels, video thumbnails for Meta, LinkedIn, TikTok), email marketing graphics, and landing page visual design.",
        },
        {
          h: "Email Template Design",
          p: "Master templates applying brand identity to email format, plus content modules (product blocks, testimonial blocks, announcement blocks, promotional blocks) enabling campaign composition from pre-designed components without bespoke design for each send.",
        },
      ],
    },
    {
      ...
      blocks: [
        {
          ...
          p: "Applying brand identity to presentation format, data visualisation and chart design communicating key metrics clearly, visual narrative supporting the verbal story, and deliverables in both editable format and polished PDF.",
        },
        {
      ...
      blocks: [
        {
          ...
          p: "Primary packaging (boxes, pouches, bottles, cans, tubes), secondary packaging (outer cartons, shipper boxes), and retail display packaging (shelf-facing with visual hierarchy for crowded retail environments).",
        },
        {
          h: "Dieline and Print-Ready Production",
          p: "Technical dieline development (flat structure template), design applied with production-safe bleed and colour management, print-ready PDF production to printer specifications, and pre-press liaison managing technical review between designer and printer.",
        },
      ],
    },
    {
  ...
  cases: [
    {
      tag: "Professional Services · Brand Rebrand",
      metric: "34%",
  ...
  why: [
    ...
    {
      icon: "Grid",
      h: "Production quality that holds at every size and format",
      p: "Professional design is tested at every scale and format: the logo at billboard scale must work at favicon scale. The colour palette on screen must be reproducible in four-colour and single-colour print. The typography at heading size must work at body copy size. We design to these production realities from the first concept.",
    },
    {
      icon: "Building",
  ...
  faqs: [
    {
      q: "How much does a professional logo and brand identity cost?",
      a: "Professional brand identity engagement (logo design, colour palette, typography, brand guidelines): $3,500-$10,000 depending on scope. Comprehensive brand identity with full application design (proposal templates, presentation templates, social media templates, key marketing materials): $10,000-$25,000. Startup brand sprint engagements: $2,500-$4,000.",
    },
    {
    ...
    },
    {
      ...
      a: "We can manage print production coordination as part of broader engagements: briefing suppliers on specifications, reviewing/approving proofs, and managing pre-press between design and production. For clients who prefer independent management, we deliver print-ready artwork to their chosen suppliers' specifications.",
    },
    {
    ...
    },
    {
      ...
      a: "Share your design brief or book a free consultation. For brand identity projects, we discuss your business's positioning, audience, competitive context, and visual communication objectives. For marketing collateral or design system projects, we review existing brand assets and discuss specific design work required. We provide a fixed-price proposal and timeline. No commitment required.",
    },
  ],
  cta: {
