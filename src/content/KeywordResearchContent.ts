export const KeywordResearchContent = {
  ...
  hero: {
    ...
    stats: [
      ...
      { k: "280%", v: "revenue growth (client example)" },
      { k: "5-7 days", v: "standard delivery timeline" },
    ],
  },
  intro: {
    problem: [
      { text: "Most businesses making their first significant SEO investment commit one of two keyword strategy errors. The first is ", type: "normal" },
      { text: "targeting terms that are too competitive", type: "highlight" },
      { text: ": broad, high-volume searches dominated by the comparison platforms, the authority publishers, and the established category leaders whose domain authority and content depth cannot be matched without years of sustained investment. The second is ", type: "normal" },
      { text: "targeting terms that have volume but lack commercial intent", type: "highlight" },
      { text: ": informational searches made by people who want free information, not by people in the market to buy what the business sells.", type: "normal" }
    ],
    solution:
  ...
  services: [
    ...
    },
    {
      ...
      icon: "Globe",
      tag: "International",
      title: "International and Multi-Language Keyword Research",
      intro: "Keyword research for multi-market and multilingual SEO programmes — UK, USA, UAE, Canada, Australia with English, Arabic, and French capabilities.",
      blocks: [
        {
          h: "Keyword Research for Multi-Market and Multilingual SEO Programmes",
  ...
  deliverables: {
    title: "What Our Keyword Research",
    titleHighlight: "Deliverables Include",
    items: [
      {
        icon: "Map",
        title: "Primary Keyword Map",
        description: "A structured spreadsheet containing every target keyword organised by: search volume (monthly, country-specific), keyword difficulty score (0-100), commercial intent rating (informational / commercial investigation / transactional), buyer journey stage (awareness / consideration / decision), current ranking position (your site), top-ranking competitor for each term, recommended target page type, programme priority score (1-5), and estimated traffic opportunity at page 1 ranking.",
      },
      {
        icon: "FileSearch",
        title: "SERP Analysis Notes",
        description: "For each priority keyword cluster, a brief analysis of the current SERP: what types of pages rank (service pages, comparison sites, content pages, local results), what the ranking page characteristics are (domain authority, content length, content type), and what this means for the realistic competitive difficulty and the right content approach.",
      },
      {
        icon: "FileText",
        title: "Content Opportunity Brief",
        description: "A mapping of the keyword map to the specific content and page types the programme requires: which keywords call for service page optimisation, which call for new landing pages, which call for blog content, and which call for FAQ or structured content treatment.",
      },
      {
        icon: "ListChecks",
        title: "Programme Priority Sequence",
        description: "A prioritised sequence for implementing the keyword strategy — starting with the highest-value, lowest-difficulty opportunities that produce early ranking wins, and building toward the more competitive terms as domain authority accumulates.",
      },
    ],
  },
  cases: [
    {
      tag: "UK Accounting Firm · Keyword Gap",
      metric: "280%",
      sub: "revenue growth · 34 terms found",
      title: "UK accounting firm revenue grows 280% after keyword map reveals 34 untargeted commercial terms.",
      body: "A UK accounting firm had been investing in SEO for 18 months without meaningful commercial return. Their existing keyword strategy targeted generic high-volume accounting terms dominated by comparison platforms and HMRC. Our keyword gap analysis identified 34 specific commercial terms — small business accountant [city], limited company accounting fees, R&D tax relief specialist — that the firm was entirely absent from, representing a combined monthly search volume of 8,400 in their target geographic markets.",
      result: "Programme response: service page and content programme targeting the 34 identified opportunity keywords, structured by commercial intent and competitive difficulty. Within 14 months, the firm ranked page 1 for 22 of the 34 target terms. Organic enquiries grew from 4/month to 28/month. Revenue from digital-originated new clients grew by 280% over 24 months.",
    },
    {
      tag: "Dallas E-Commerce · Product Keywords",
      metric: "$340K",
      sub: "new organic revenue · 280 opportunities",
      title: "Dallas e-commerce brand generates $340K in new organic revenue from product keyword research.",
      body: "A Dallas-based DTC outdoor equipment brand had product pages targeting generic product names but not the specific commercial search terms — 'waterproof hiking boots under $150', 'best trail running backpack for women', 'ultralight tent 2 person' — that represented the buyer-intent searches preceding the purchasing decisions in their category. Keyword gap analysis against the top 5 organic competitors revealed 280 product and category keyword opportunities the brand was invisible for.",
      result: "Programme response: product description and category page optimisation for the 280 identified keywords, plus a buying guide content programme targeting the commercial research keywords. Within 16 months, organic product search rankings grew from 420 to 3,800 keyword positions. Organic revenue grew from $28,000/month to $56,000/month. The buying guide content programme generated 28% of new organic revenue through embedded product links.",
    },
    {
      tag: "Dubai Healthcare · Arabic Search",
      metric: "0 → 480",
      sub: "monthly Arabic sessions · 12 new patients/mo",
      title: "Dubai healthcare practice discovers Arabic keyword opportunity, gains 480 monthly organic sessions.",
      body: "A Dubai specialist healthcare practice had an English-only SEO programme that captured approximately 60% of the available search opportunity — the English-language searches from Dubai's expatriate population. Arabic keyword research revealed that 40% of the relevant searches in the practice's specialty area were conducted in Arabic, with significantly lower competition than English equivalents.",
      result: "Programme response: Arabic-language service pages targeting the identified Arabic keyword opportunities. Within 10 months, Arabic-language organic traffic grew from 0 to 480 monthly sessions. New patient enquiries from Arabic-language search grew to 12/month — a commercially significant channel the English-only programme had been entirely invisible to.",
    },
  ],
  why: [
    {
      icon: "Target",
      h: "Commercial intent as the primary filter",
      p: "We prioritise commercial intent above search volume in every keyword research engagement. The 500-volume keyword that represents a buyer actively seeking the business's services produces more commercial value than the 5,000-volume keyword attracting researchers and students. Our keyword maps are built around the specific combination of intent, volume, and competitive difficulty that produces the best commercial return on SEO investment — not the terms that look most impressive in a volume report.",
    },
    {
      icon: "BarChart3",
      h: "Market-specific competitive analysis",
      p: "Keyword difficulty is not a universal number — it is market-specific. The competitive landscape for 'family law solicitor' in rural Yorkshire is fundamentally different from the same search in Central London. We analyse keyword difficulty in the specific geographic and competitive context of each client's market, not as an abstract score.",
    },
    {
      icon: "Globe",
      h: "Multi-market and multilingual expertise",
      p: "We provide keyword research for clients in all six of our primary markets — UK, USA, UAE, Pakistan, Canada, and Australia — with the market-specific vocabulary knowledge, the competitive landscape understanding, and where required the bilingual (Arabic, French) keyword capability that effective multi-market SEO demands.",
    },
  ],
  faqs: [
    {
      q: "How is professional keyword research different from using a free tool?",
      a: "Free keyword tools provide volume and difficulty data — useful but incomplete. Professional keyword research adds the commercial intent analysis that determines whether a term represents a buyer or a researcher; the competitive difficulty assessment that considers the specific nature of the competing pages, not just a score; the market-specific vocabulary knowledge that ensures the keyword map reflects how your specific market actually searches; and the strategic prioritisation framework that sequences the keyword targets in the order most likely to produce early ranking wins and long-term commercial impact. The difference is between a list of terms and a commercially actionable strategy.",
    },
    {
      q: "How long does keyword research take?",
      a: "Our standard commercial keyword mapping engagement takes 5-7 business days for a single-market, single-service-area business. Multi-location, multi-service, or multi-market engagements typically take 10-15 business days. Rush delivery is available.",
    },
    {
      q: "Do you provide keyword research as a standalone service or only as part of an SEO programme?",
      a: "Both. We provide standalone keyword research for businesses that have in-house SEO teams or existing agency relationships that need the research foundation. We also provide keyword research as the first phase of every new SEO programme engagement — the foundation on which the programme strategy is built.",
    },
    {
      q: "How often should keyword research be refreshed?",
      a: "For most businesses, a full keyword research refresh is appropriate annually — search volumes change, competitor landscapes shift, and new search term opportunities emerge as the market evolves. For businesses in fast-moving sectors (technology, financial services, healthcare), a semi-annual refresh is worth considering. Beyond the full refresh, the ongoing monitoring of ranking changes and emerging search opportunities is part of our standard SEO programme management.",
    },
    {
      q: "Can you do keyword research for non-English languages?",
      a: "Yes — we provide Arabic keyword research for UAE and GCC markets, and French keyword research for the Canadian (specifically Québécois French) market. For other languages, contact us to discuss your specific requirements.",
    },
  ],
  cta: {
