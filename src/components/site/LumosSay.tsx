...
export const LumosSay = () => {
  ...
  return (
<section ref={ref} className="relative py-12 overflow-visible">
  {/* Headline stack */}
  <div className="w-full relative">
    <div className="relative leading-[0.85] font-display select-none -ml-[8vw] md:-ml-[5vw]">
      {/* Row 1: outlined "what" */}
      <motion.div
        style={{ y: yWhat }}
      ...
      <motion.div
        style={{ x: xNova }}
        className="font-sans font-black uppercase text-[18vw] md:text-[13vw] -mt-[4vw]"
      >
        ClickMasters
      </motion.div>
    </div>
